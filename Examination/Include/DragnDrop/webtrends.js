...
//These parameters will be declared in the calling jsp file.
//var gDomain="%VIPADDRESS%";
//var gDcsId="%DCSID%";
...
function setWTParams()
{
        ...
        for (var i = 0; i < pairs.length; i++)
        {
                ...
                if (argname.indexOf('WT.') == 0)
                {
                        eval(argname + '=' + '\'' + value + '\';'); //setting the WT.VARNAME value.
                }
        }
}
...
try
{
        dcsAdditionalParameters();
}
catch (e)
{} //implement this method to all added funtionality or parameters to web trends ping
try
{
        setWTParams();
}
catch (e)
{} //overwrite the WT parameters set by dcsAdditionalParameters()
dcsTag();