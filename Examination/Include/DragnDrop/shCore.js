...
dp.sh.Utils.About = function ()
{
        ...
        doc.write('<style type="text/css">' + styles[i].innerHTML + '</style>');

        for (var i = 0; i < links.length; i++)
        if (links[i].rel.toLowerCase() == 'stylesheet') doc.write('<link type="text/css" rel="stylesheet" href="' + links[i].href + '"></link>');
        ...
        if (css != null)
        {
                ...
                if (regex.test(str))
                {
                        ...
                        for (var i = 0; i < lines.length; i++)
                        {
                                ...
                                if (i + 1 < lines.length) this.div.appendChild(document.createElement('BR'));
                        }
                }
                else
                {
...
dp.sh.Highlighter.prototype.SwitchToTable = function ()
{
        ...
        if (this.addControls == true)
        {
                ...
                if (window.clipboardData) cell.innerHTML += pipe + UtilHref('ToClipboard', dp.sh.Strings.CopyToClipboard);
...
dp.sh.Highlighter.prototype.Highlight = function (code)
{
        ...
        if (this.CssClass != null) this.table.className = this.CssClass;
