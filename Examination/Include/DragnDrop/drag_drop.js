                        ...
                        if (activeCont)
                        {
                                ...
                                for (var i = activeCont.childNodes.length - 1; i >= 0; i--)
                                {
                                        with(activeCont.childNodes[i])
                                        {
                                                ...
                                                if (curTarget != activeCont.childNodes[i] && ((parseInt(getAttribute('startLeft')) + parseInt(getAttribute('startWidth'))) > xPos) && ((parseInt(getAttribute('startTop')) + parseInt(getAttribute('startHeight'))) > yPos))
                                                {
...
window.onload = function ()
{
        ...
        if (Demos[4])
        {
        //var SetsWanted = document.getElementById('Demo' + i); , document.getElementById('DragContainer4')
	        var nSets = document.getElementById('TxtSets').value;
			if (nSets == 1)
			{
			...
			if (nSets == 4)
			{
            CreateDragContainer(document.getElementById('DragContainer1'), document.getElementById('DragContainer2'), document.getElementById('DragContainer3'), document.getElementById('DragContainer4'));
			}
        }
        if (Demos[0] || Demos[4])
        {
