...
function isDate(dtStr,FieldName){
	...
	year=parseInt(strYr)
	if (pos1==-1 || pos2==-1){
		alert(FieldName + " format should be : dd/mm/yyyy")
		return false
	}
...
function ValidateForm(objField,FieldName){
	//if (isWhitespace(objField)) return true;
	if (objField.value=='') return true;
	if (isDate(objField.value,FieldName)==false){
		objField.focus()
		return false
	}
    return true
...
strYr=strYr.substring(1)
	...
	alert(FieldName + " format should be : mm/dd/yyyy")
		return false
	}
...
function ValidateForm(objField){
//alert("Please enter a valid date")
	//var dt=document.frmSample.txtDate
		if (isDate(objField.value)==false){
	//alert("Please enter a valid date")
		objField.focus()
		return false
	}
