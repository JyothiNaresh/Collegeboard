...
(function () {
    ...
    Ea = {
        ...
        credits: {
            enabled: !0,
            text: "Narayanagroup.com",
            href: "http://www.narayanagroup.com",
            position: {
                align: "right",
                x: -10,
                verticalAlign: "bottom",
    ...
    Eb.prototype = {
                ...
                o(h, function (c) {
                    if (c !== "" || h.length === 1) {
                        ...
                        if (i) for (var c = c.replace(/-/g, "- ").split(" "), q, T = []; c.length || T.length;) q = a.getBBox().width, l = q > i, !l || c.length === 1 ? (c = T, T = [], c.length && (o = x.createElementNS("http://www.w3.org/2000/svg", "tspan"), A(o, {
                            dy: k || 16,
                            x: g
                        }), b.appendChild(o), q > i && (i = q))) : (o.removeChild(o.firstChild),
        ...
        color: function (a, b, c) {
            ...
            if (a && a.linearGradient) {
                ...
                h = f.createElement("linearGradient").attr(L({
                    id: g,
                    x1: i,
                    y1: k,
                    x2: j,
    ...
    if (!Pb && !Fa) $a = {
        ...
        shadow: function (a, b) {
            ...
            if (a) {
                ...
                7 - 2 * d, '" filled="false" path="', k, '" coordsize="100,100" style="', e.style.cssText, '" />'], g = Aa(f.prepVML(i), null, {
                    left: S(h.left) + 1,
                    top: S(h.top) + 1
        ...
        drawGraph: function () {
            ...
            o(a.segments, function (c) {
                ...
                if (t) {
                    ...
                    else e.push(fa, c[c.length - 1].plotX,
                    n, fa, c[0].plotX, n);
                    s = s.concat(e)
                }
            });
