     ...
     $.extend({
         ...
         tablesorter: new function () {
             ...
             function multisort(table) { /*jshint loopfunc:true */
                 var dynamicExp, sortWrapper, col, mx = 0,
                     dir = 0,
                     tc = table.config,
             ...
             ts.construct = function (settings) {
                 return this.each(function () {
                     ...
                     if (c.debug) {
                         $.data(this, 'startoveralltimer', new Date());
                     }
                     // constants
                     ...
                     .find('*').andSelf().filter(c.selectorSort)
                         ...
                         var $cell = this.tagName.match('TH|TD') ? $(this) : $(this).parents('th, td').filter(':last'),
                             cell = $cell[0];
                     ...
                     $this.unbind('sortReset update updateCell addRows sorton appendCache applyWidgetId applyWidgets refreshWidgets destroy mouseup mouseleave')
