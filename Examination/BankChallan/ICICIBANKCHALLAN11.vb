...
Public Class ICICIBANKCHALLAN1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CollegeBoard.ICICIBANKCHALLAN1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedICICIBANKCHALLAN1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ICICIBANKCHALLAN1 = New ICICIBANKCHALLAN1()
        rpt.Site = Me.Site
        Return rpt
    End Function
