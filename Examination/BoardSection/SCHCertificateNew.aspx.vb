...
Public Class SCHCertificateNew
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents drptraffic1 As System.Web.UI.WebControls.DropDownList
    Protected WithEvents drptraffic2 As System.Web.UI.WebControls.DropDownList
    'Protected WithEvents drpplyground1 As System.Web.UI.WebControls.DropDownList
    'Protected WithEvents drpplyground2 As System.Web.UI.WebControls.DropDownList

    'Protected WithEvents drpaddsec1 As System.Web.UI.WebControls.DropDownList
    'Protected WithEvents drpaddsec2 As System.Web.UI.WebControls.DropDownList
...
#Region "Class Variables"
    ...
    Dim bool, bool1, bool2, bool3, bool4, bool5, bool6, bool7, bool8, bool9, bool10, bool11, bool12 As Boolean
#End Region
...
#Region "Methods"
    ...
    Private Function SetEntries() As ArrayList
        Try
            ...
            If Me.ViewState("MODE") = "NEW" Then
                ...
                Arr.Add(Val(drptraffic1.SelectedValue))
                Arr.Add(Val(drpnoc1.SelectedValue))
                Arr.Add(Val(drpplyground1.SelectedValue))
                Arr.Add(Val(drpaddsec1.SelectedValue))
                Arr.Add(Val(drplease1.SelectedValue))
                Arr.Add(Val(drpbuilding1.SelectedValue))
                Arr.Add(Val(drpsketch1.SelectedValue))
                Arr.Add(Val(drppp1.SelectedValue))
                Arr.Add(Val(drpOF1.SelectedValue))
                Arr.Add(Val(drpST1.SelectedValue))
                Arr.Add(Val(drpAmount1.SelectedValue))
                Arr.Add(Val(Drpfire2.SelectedValue))
                Arr.Add(Val(drpsant2.SelectedValue))
                Arr.Add(Val(drptraffic2.SelectedValue))
                Arr.Add(Val(drpnoc2.SelectedValue))
                Arr.Add(Val(drpplyground2.SelectedValue))
                Arr.Add(Val(drpaddsec2.SelectedValue))
                Arr.Add(Val(drplease2.SelectedValue))
                Arr.Add(Val(drpbuilding2.SelectedValue))
                Arr.Add(Val(drpsketch2.SelectedValue))
                Arr.Add(Val(drppp2.SelectedValue))
                Arr.Add(Val(drpOF2.SelectedValue))
                Arr.Add(Val(drpST2.SelectedValue))
                Arr.Add(Val(drpAmount2.SelectedValue))
                ...
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                If Trim(txtstrafromdate.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtstrafromdate.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                If Trim(txtstratodate.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtstratodate.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                ...
                If Trim(txtplaygroundfrom.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtplaygroundfrom.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If

                If Trim(txtplaygroundto.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtplaygroundto.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                ...
                If Trim(txtbuildingfrom.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtbuildingfrom.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                If Trim(txtbuildingto.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtbuildingto.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If

                If Trim(txtsketchfrom.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtsketchfrom.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If

                If Trim(txtsketchto.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtsketchto.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                If Trim(txtppfrom.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtppfrom.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If

                If Trim(txtppto.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtppto.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If

                If Trim(txtOFfrom.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtOFfrom.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                If Trim(txtOFto.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtOFto.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                If Trim(txtSTfrom.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtSTfrom.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                If Trim(txtSTTo.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtSTTo.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If

                If Trim(txtAmountfrom.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtAmountfrom.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                If Trim(txtAmountto.Text) <> "" Then
                    Arr.Add(DateConversion(Trim(txtAmountto.Text)))
                Else
                    Arr.Add(System.DBNull.Value)
                End If
                Arr.Add(Val(MNO))
    ...
    Private Sub FillControls()
        Try
            ...
            If DsGA.Tables(0).Rows.Count > 0 Then
                ...
                drptraffic1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("STRUCTURALSLNO1").ToString)
                drpnoc1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("NOCSLNO1").ToString)


                drpplyground1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("PLAYGROUNDSLNO1").ToString)
                drpaddsec1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("ADDISECTIONSLNO1").ToString)
                drplease1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("REGLEASEDEEDSLNO1").ToString)
                drpbuilding1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("BUILDINGPERMISLNO1").ToString)

                drpsketch1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("SKETCHPLANSLNO1").ToString)
                drppp1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("RECPPSLNO1").ToString)
                drpOF1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("REC_I_V_SLNO1").ToString)
                drpST1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("REC_VI_X_SLNO1").ToString)
                drpAmount1.SelectedValue = Val(DsGA.Tables(0).Rows(0)("NATIOAMOUNTSLNO1").ToString)
                ...
                If drpplyground1.SelectedValue = 1 Then
                    drpplyground2.Enabled = True
                    txtplaygroundfrom.Enabled = True
                    txtplaygroundto.Enabled = True
                    'cermunpath1.Disabled = False
                    HyperLink1.Enabled = True
                Else
                    drpplyground2.Enabled = True
                ...
                If drpaddsec1.SelectedValue = 1 Then
                    drpaddsec2.Enabled = True
                    txtsecfrom.Enabled = True
                    txtsecto.Enabled = True
                    'cermunpath1.Disabled = False
                    HyperLink2.Enabled = True
                ...
                If drplease1.SelectedValue = 1 Then
                    drplease2.Enabled = True
                    txtleasefrom.Enabled = True
                    txtleaseto.Enabled = True
                    'cermunpath1.Disabled = False
                    HyperLink3.Enabled = True
                ...
                If drpbuilding1.SelectedValue = 1 Then
                    drpbuilding2.Enabled = True
                    txtbuildingfrom.Enabled = True
                    txtbuildingto.Enabled = True
                    'cermunpath1.Disabled = False
                ...
                If drpsketch1.SelectedValue = 1 Then
                    drpsketch2.Enabled = True
                    txtsketchfrom.Enabled = True
                    txtsketchto.Enabled = True
                    'cermunpath1.Disabled = False
                    Hyperlink5.Enabled = True
                Else
                    drpsketch2.Enabled = True
                ...
                If drppp1.SelectedValue = 1 Then
                    drppp2.Enabled = True
                    txtppfrom.Enabled = True
                    txtppto.Enabled = True
                    'cermunpath1.Disabled = False
                ...
                If drpOF1.SelectedValue = 1 Then
                    drpOF2.Enabled = True
                    txtOFfrom.Enabled = True
                    txtOFto.Enabled = True
                    'cermunpath1.Disabled = False
                ...
                If drpST1.SelectedValue = 1 Then
                    drpST2.Enabled = True
                ...
                If drpAmount1.SelectedValue = 1 Then
                    drpAmount2.Enabled = True
                ...
                drptraffic2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("STRUCTURALSLNO2").ToString)
                drpnoc2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("NOCSLNO2").ToString)



                drpplyground2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("PLAYGROUNDSLNO2").ToString)
                drpaddsec2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("ADDISECTIONSLNO2").ToString)
                drplease2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("REGLEASEDEEDSLNO2").ToString)
                drpbuilding2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("BUILDINGPERMISLNO2").ToString)

                drpsketch2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("SKETCHPLANSLNO2").ToString)
                drppp2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("RECPPSLNO2").ToString)
                drpOF2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("REC_I_V_SLNO2").ToString)
                drpST2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("REC_VI_X_SLNO2").ToString)
                drpAmount2.SelectedValue = Val(DsGA.Tables(0).Rows(0)("NATIOAMOUNTSLNO2").ToString)
                ...
                txtplaygroundfrom.Text = Trim(DsGA.Tables(0).Rows(0)("PLAYGROUNDFROM").ToString)
                txtplaygroundto.Text = Trim(DsGA.Tables(0).Rows(0)("PLAYGROUNDTO").ToString)
                txtsecfrom.Text = Trim(DsGA.Tables(0).Rows(0)("ADDISECTIONFROM").ToString)
                txtsecto.Text = Trim(DsGA.Tables(0).Rows(0)("ADDISECTIONTO").ToString)
                txtleasefrom.Text = Trim(DsGA.Tables(0).Rows(0)("REGLEASEDEEDFROM").ToString)
                txtleaseto.Text = Trim(DsGA.Tables(0).Rows(0)("REGLEASEDEEDTO").ToString)
                txtbuildingfrom.Text = Trim(DsGA.Tables(0).Rows(0)("BUILDINGPERMIFROM").ToString)
                txtbuildingto.Text = Trim(DsGA.Tables(0).Rows(0)("BUILDINGPERMITO").ToString)

                txtsketchfrom.Text = Trim(DsGA.Tables(0).Rows(0)("SKETCHPLANFROM").ToString)
                txtsketchto.Text = Trim(DsGA.Tables(0).Rows(0)("SKETCHPLANTO").ToString)
                txtppfrom.Text = Trim(DsGA.Tables(0).Rows(0)("RECPPFROM").ToString)
                txtppto.Text = Trim(DsGA.Tables(0).Rows(0)("RECPPPTO").ToString)
                txtOFfrom.Text = Trim(DsGA.Tables(0).Rows(0)("REC_I_V_FROM").ToString)
                txtOFto.Text = Trim(DsGA.Tables(0).Rows(0)("REC_I_V_TO").ToString)
                txtSTfrom.Text = Trim(DsGA.Tables(0).Rows(0)("REC_VI_X_FROM").ToString)
                txtSTTo.Text = Trim(DsGA.Tables(0).Rows(0)("REC_VI_X_TO").ToString)
                txtAmountfrom.Text = Trim(DsGA.Tables(0).Rows(0)("NATIOAMOUNTFROM").ToString)
                txtAmountto.Text = Trim(DsGA.Tables(0).Rows(0)("NATIOAMOUNTTO").ToString)
                ...
                HypNew3.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("TRAFFICPATH").ToString)
                HypNew4.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("NOCPATH").ToString)
                HyperLink1.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("PLAYGROUNDPATH").ToString)
                HyperLink2.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("ADDISECTIONPATH").ToString)
                Hyperlink4.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("REGLEASEDEEDPATH").ToString)
                Hyperlink5.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("BUILDINGPERMIPATH").ToString)

                HyperLink6.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("SKETCHPLANPATH").ToString)
                HyperLink7.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("RECPPPATH").ToString)
                HyperLink8.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("REC_I_V_PATH").ToString)
                HyperLink9.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("REC_VI_X_PATH").ToString)
                HyperLink10.NavigateUrl = Trim(DsGA.Tables(0).Rows(0)("NATIOAMOUNTPATH").ToString)
    ...
    Private Sub ClearControls()
        Try
            ...
            drptraffic1.SelectedItem.Text = "Select"
            drpnoc1.SelectedItem.Text = "Select"
            drpplyground1.SelectedItem.Text = "Select"
            drpaddsec1.SelectedItem.Text = "Select"
            drplease1.SelectedItem.Text = "Select"
            drpbuilding1.SelectedItem.Text = "Select"
            drpsketch1.SelectedItem.Text = "Select"
            drppp1.SelectedItem.Text = "Select"
            drpOF1.SelectedItem.Text = "Select"
            drpST1.SelectedItem.Text = "Select"
            drpAmount1.SelectedItem.Text = "Select"
            drpnoc1.SelectedItem.Text = "Select"
            Drpfire2.SelectedItem.Text = "Select"
            drpsant2.SelectedItem.Text = "Select"
            drptraffic2.SelectedItem.Text = "Select"
            drpnoc2.SelectedItem.Text = "Select"
            drpplyground2.SelectedItem.Text = "Select"
            drpaddsec2.SelectedItem.Text = "Select"
            drplease2.SelectedItem.Text = "Select"
            drpbuilding2.SelectedItem.Text = "Select"
            drpsketch2.SelectedItem.Text = "Select"
            drppp2.SelectedItem.Text = "Select"
            drpOF2.SelectedItem.Text = "Select"
            drpST2.SelectedItem.Text = "Select"
            drpAmount2.SelectedItem.Text = "Select"
    ...
    Private Function FormValidations() As Boolean
        Try
            Dim extension, Fcerfirepath1, Fcersanpath1, Fcerstrpath1, Fcermunpath1, Fplaygroundpath1, Fsecpath1, Fleasepath1, Fbuildingpath1, Fskecthpath1, Fpppath1 As String
            Dim Fonefourpath1, FSTpath1, FAmountpath1 As String
            ...
            Fplaygroundpath1 = Path.GetFileName(cerplaygroundpath1.PostedFile.FileName)
            Dim contentType5 As String = cerplaygroundpath1.PostedFile.ContentType

            Fsecpath1 = Path.GetFileName(cersecpath1.PostedFile.FileName)
            Dim contentType6 As String = cersecpath1.PostedFile.ContentType

            Fleasepath1 = Path.GetFileName(cerleasepath1.PostedFile.FileName)
            Dim contentType7 As String = cerleasepath1.PostedFile.ContentType

            Fbuildingpath1 = Path.GetFileName(cerbuildingpath1.PostedFile.FileName)
            Dim contentType8 As String = cerbuildingpath1.PostedFile.ContentType

            Fskecthpath1 = Path.GetFileName(cerskecthpath1.PostedFile.FileName)
            Dim contentType9 As String = cerskecthpath1.PostedFile.ContentType

            Fpppath1 = Path.GetFileName(cerspppath1.PostedFile.FileName)
            Dim contentType10 As String = cerspppath1.PostedFile.ContentType

            Fonefourpath1 = Path.GetFileName(cersonefourpath1.PostedFile.FileName)
            Dim contentType11 As String = cersonefourpath1.PostedFile.ContentType

            FSTpath1 = Path.GetFileName(cersSTpath1.PostedFile.FileName)
            Dim contentType12 As String = cersSTpath1.PostedFile.ContentType

            FAmountpath1 = Path.GetFileName(cersAmountpath1.PostedFile.FileName)
            Dim contentType13 As String = cersAmountpath1.PostedFile.ContentType
            ...
            If Trim(Txtccode.Text) = "" Or Trim(Txtccode.Text) Is Nothing Then
                ...
                '    Return False
            ElseIf drptraffic1.SelectedItem.Text = "Select" Then
                StartUpScript(drptraffic1.ID, "Select Fire Certificate.")
                Return False
    ...
    Private Function SaveText2() As Boolean
        Try
            ...
            If cerstrpath1.PostedFile.FileName <> "" Then
                ...
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET TRAFFICPATH='" & " F:/BOARD_CERT/" & STRSTR + FileExtnStr.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If
            ...
            If cerplaygroundpath1.PostedFile.FileName <> "" Then
                Dim FileExtnMun As String = GetExtension(cerplaygroundpath1.PostedFile.FileName)
                ...
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                End If
                cerplaygroundpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET PLAYGROUNDPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If


            If cersecpath1.PostedFile.FileName <> "" Then
                Dim FileExtnMun As String = GetExtension(cersecpath1.PostedFile.FileName)
                ...
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                End If
                cersecpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET ADDISECTIONPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If


            If cerleasepath1.PostedFile.FileName <> "" Then
                Dim FileExtnMun As String = GetExtension(cerleasepath1.PostedFile.FileName)
                ...
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                End If
                cerleasepath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET REGLEASEDEEDPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If

            If cerbuildingpath1.PostedFile.FileName <> "" Then
                Dim FileExtnMun As String = GetExtension(cerbuildingpath1.PostedFile.FileName)
                ...
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                End If
                cerbuildingpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET BUILDINGPERMIPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If

            If cerskecthpath1.PostedFile.FileName <> "" Then
                Dim FileExtnMun As String = GetExtension(cerskecthpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-9"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                End If
                cerskecthpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET SKETCHPLANPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If
            If cerspppath1.PostedFile.FileName <> "" Then
                Dim FileExtnMun As String = GetExtension(cerspppath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-10"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                End If
                cerspppath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET RECPPPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If

            If cersonefourpath1.PostedFile.FileName <> "" Then
                Dim FileExtnMun As String = GetExtension(cersonefourpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-11"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                End If
                cersonefourpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET REC_I_V_PATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If

            If cersSTpath1.PostedFile.FileName <> "" Then
                Dim FileExtnMun As String = GetExtension(cersSTpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-12"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                End If
                cersSTpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET REC_VI_X_PATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If

            If cersAmountpath1.PostedFile.FileName <> "" Then
                Dim FileExtnMun As String = GetExtension(cersAmountpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-13"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                End If
                cersAmountpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString)
                FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET NATIOAMOUNTPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnMun.ToString & "' WHERE CCODE=" & Session("CCODE"))
            End If
            Return True
    ...
    Private Function SaveText() As Boolean
        Try
            ...
            If cerplaygroundpath1.PostedFile.FileName <> "" Then
                Dim FileExtnAff As String = GetExtension(cerplaygroundpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-5"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                ...
                End If
                cerplaygroundpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnAff.ToString)
                'FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET PLAYGROUNDPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnAff.ToString & "' WHERE CCODE=" & Session("CCODE"))
            Else
                StartUpScript(iBtnSave.ID, "Image Size Exceeds 500KB..ToResize Images Goto : http://www.picresize.com")
            End If
            ...
            If cersecpath1.PostedFile.FileName <> "" Then
                ...
                'FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET ADDISECTIONPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnsec.ToString & "' WHERE CCODE=" & Session("CCODE"))
            Else
                StartUpScript(iBtnSave.ID, "Image Size Exceeds 500KB..ToResize Images Goto : http://www.picresize.com")
            End If
            ...
            If cerleasepath1.PostedFile.FileName <> "" Then
                ...
                'FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET REGLEASEDEEDPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnlease.ToString & "' WHERE CCODE=" & Session("CCODE"))
            Else
                StartUpScript(iBtnSave.ID, "Image Size Exceeds 500KB..ToResize Images Goto : http://www.picresize.com")
            End If

            If cerbuildingpath1.PostedFile.FileName <> "" Then
                Dim FileExtnfdr As String = GetExtension(cerbuildingpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-8"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                ...
                End If
                cerbuildingpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                'FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET BUILDINGPERMIPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString & "' WHERE CCODE=" & Session("CCODE"))
            Else
                StartUpScript(iBtnSave.ID, "Image Size Exceeds 500KB..ToResize Images Goto : http://www.picresize.com")
            End If
            ...
            If cerskecthpath1.PostedFile.FileName <> "" Then
                Dim FileExtnfdr As String = GetExtension(cerskecthpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-8"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                End If
                cerskecthpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                'FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET SKETCHPLANPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString & "' WHERE CCODE=" & Session("CCODE"))
            Else
                StartUpScript(iBtnSave.ID, "Image Size Exceeds 500KB..ToResize Images Goto : http://www.picresize.com")
            End If
            If cerspppath1.PostedFile.FileName <> "" Then
                Dim FileExtnfdr As String = GetExtension(cerspppath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-8"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                End If
                cerspppath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                'FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET RECPPPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString & "' WHERE CCODE=" & Session("CCODE"))
            Else
                StartUpScript(iBtnSave.ID, "Image Size Exceeds 500KB..ToResize Images Goto : http://www.picresize.com")
            End If
            If cersonefourpath1.PostedFile.FileName <> "" Then
                Dim FileExtnfdr As String = GetExtension(cersonefourpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-8"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                End If
                cersonefourpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                'FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET REC_I_V_PATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString & "' WHERE CCODE=" & Session("CCODE"))
            Else
                StartUpScript(iBtnSave.ID, "Image Size Exceeds 500KB..ToResize Images Goto : http://www.picresize.com")
            End If
            If cersSTpath1.PostedFile.FileName <> "" Then
                Dim FileExtnfdr As String = GetExtension(cersSTpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-8"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                End If
                cersSTpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                'FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET REC_VI_X_PATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString & "' WHERE CCODE=" & Session("CCODE"))
            Else
                StartUpScript(iBtnSave.ID, "Image Size Exceeds 500KB..ToResize Images Goto : http://www.picresize.com")
            End If
            If cersAmountpath1.PostedFile.FileName <> "" Then
                Dim FileExtnfdr As String = GetExtension(cersAmountpath1.PostedFile.FileName)
                Dim STRMUN As String = Session("CCODE") + "-8"
                If Not Directory.Exists("F:/BOARD_CERT") Then
                    Directory.CreateDirectory("F:/BOARD_CERT")
                End If
                If FileDum.Exists("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString) Then
                    FileDum.Delete("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                End If
                cersAmountpath1.PostedFile.SaveAs("F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString)
                'FILEPATH = "HTTP://" & Request.ServerVariables("HTTP_HOST") & "\BOARD_CERT\" & STRMUN + FileExtnMun.ToString
                StrSql = objMaster.PATH_SAVE("UPDATE M_CERTIFICATES_DT SET NATIOAMOUNTPATH='" & " F:/BOARD_CERT/" & STRMUN + FileExtnfdr.ToString & "' WHERE CCODE=" & Session("CCODE"))
            Else
                StartUpScript(iBtnSave.ID, "Image Size Exceeds 500KB..ToResize Images Goto : http://www.picresize.com")
            End If
...
#Region "Events"
    ...
    Private Sub iBtnSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSave.Click
        Try
            ...
            If Fskecthpath1 = "" Then

                bool8 = True

            Else
                If contentType9 = "application/pdf" Then
            ...
            Else
                If contentType10 = "application/pdf" Then
            ...
            If Fonefourpath1 = "" Then

                bool10 = True

            Else
                If contentType11 = "application/pdf" Then
            ...
            Else
                If contentType12 = "application/pdf" Then
            ...
            If FAmountpath1 = "" Then

                bool12 = True

            Else
                If contentType13 = "application/pdf" Then
            ...
            If (bool = True And bool1 = True And bool2 = True And bool3 = True And bool4 = True And bool5 = True And bool6 = True And bool7 = True And bool8 = True And bool9 = True And bool10 = True And bool11 = True And bool12 = True) Then

                If (Me.ViewState("MODE")) = "EDIT" Then

                    ' FileExtension = GettingFileExtension()

                    RtnVal = objMaster.CERTIFICT_UpdateNewSCHOOL(SetEntries())
                    If RtnVal = 1 Then
                ...
                ElseIf (Me.ViewState("MODE")) = "NEW" Then
                    ...
                    RtnVal = objMaster.CERTIFICT_InsertNewSCHOOL(SetEntries())
                    If RtnVal = 1 Then
...
#Region "DROPS"
    Private Sub FillFire()
        Try
            ...
            drptraffic1.Items.Clear()
            drptraffic1.Items.Insert(0, New ListItem("--Select--", 0))
            drptraffic1.Items.Insert(1, New ListItem("Yes", 1))
            drptraffic1.Items.Insert(2, New ListItem("No", 2))
            ...
            drptraffic2.Items.Clear()
            drptraffic2.Items.Insert(0, New ListItem("--Select--", 0))
            drptraffic2.Items.Insert(1, New ListItem("Submitted", 1))
            drptraffic2.Items.Insert(2, New ListItem("Not Submitted", 2))
            ...
            drpplyground1.Items.Clear()
            drpplyground1.Items.Insert(0, New ListItem("--Select--", 0))
            drpplyground1.Items.Insert(1, New ListItem("Submitted", 1))
            drpplyground1.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpaddsec1.Items.Clear()
            drpaddsec1.Items.Insert(0, New ListItem("--Select--", 0))
            drpaddsec1.Items.Insert(1, New ListItem("Submitted", 1))
            drpaddsec1.Items.Insert(2, New ListItem("Not Submitted", 2))

            drplease1.Items.Clear()
            drplease1.Items.Insert(0, New ListItem("--Select--", 0))
            drplease1.Items.Insert(1, New ListItem("Submitted", 1))
            drplease1.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpbuilding1.Items.Clear()
            drpbuilding1.Items.Insert(0, New ListItem("--Select--", 0))
            drpbuilding1.Items.Insert(1, New ListItem("Submitted", 1))
            drpbuilding1.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpsketch1.Items.Clear()
            drpsketch1.Items.Insert(0, New ListItem("--Select--", 0))
            drpsketch1.Items.Insert(1, New ListItem("Submitted", 1))
            drpsketch1.Items.Insert(2, New ListItem("Not Submitted", 2))

            drppp1.Items.Clear()
            drppp1.Items.Insert(0, New ListItem("--Select--", 0))
            drppp1.Items.Insert(1, New ListItem("Submitted", 1))
            drppp1.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpOF1.Items.Clear()
            drpOF1.Items.Insert(0, New ListItem("--Select--", 0))
            drpOF1.Items.Insert(1, New ListItem("Submitted", 1))
            drpOF1.Items.Insert(2, New ListItem("Not Submitted", 2))
            drpST1.Items.Clear()
            drpST1.Items.Insert(0, New ListItem("--Select--", 0))
            drpST1.Items.Insert(1, New ListItem("Submitted", 1))
            drpST1.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpAmount1.Items.Clear()
            drpAmount1.Items.Insert(0, New ListItem("--Select--", 0))
            drpAmount1.Items.Insert(1, New ListItem("Submitted", 1))
            drpAmount1.Items.Insert(2, New ListItem("Not Submitted", 2))


            drpplyground2.Items.Clear()
            drpplyground2.Items.Insert(0, New ListItem("--Select--", 0))
            drpplyground2.Items.Insert(1, New ListItem("Submitted", 1))
            drpplyground2.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpaddsec2.Items.Clear()
            drpaddsec2.Items.Insert(0, New ListItem("--Select--", 0))
            drpaddsec2.Items.Insert(1, New ListItem("Submitted", 1))
            drpaddsec2.Items.Insert(2, New ListItem("Not Submitted", 2))

            drplease2.Items.Clear()
            drplease2.Items.Insert(0, New ListItem("--Select--", 0))
            drplease2.Items.Insert(1, New ListItem("Submitted", 1))
            drplease2.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpbuilding2.Items.Clear()
            drpbuilding2.Items.Insert(0, New ListItem("--Select--", 0))
            drpbuilding2.Items.Insert(1, New ListItem("Submitted", 1))
            drpbuilding2.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpsketch2.Items.Clear()
            drpsketch2.Items.Insert(0, New ListItem("--Select--", 0))
            drpsketch2.Items.Insert(1, New ListItem("Submitted", 1))
            drpsketch2.Items.Insert(2, New ListItem("Not Submitted", 2))

            drppp2.Items.Clear()
            drppp2.Items.Insert(0, New ListItem("--Select--", 0))
            drppp2.Items.Insert(1, New ListItem("Submitted", 1))
            drppp2.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpOF2.Items.Clear()
            drpOF2.Items.Insert(0, New ListItem("--Select--", 0))
            drpOF2.Items.Insert(1, New ListItem("Submitted", 1))
            drpOF2.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpST2.Items.Clear()
            drpST2.Items.Insert(0, New ListItem("--Select--", 0))
            drpST2.Items.Insert(1, New ListItem("Submitted", 1))
            drpST2.Items.Insert(2, New ListItem("Not Submitted", 2))

            drpAmount2.Items.Clear()
            drpAmount2.Items.Insert(0, New ListItem("--Select--", 0))
            drpAmount2.Items.Insert(1, New ListItem("Submitted", 1))
            drpAmount2.Items.Insert(2, New ListItem("Not Submitted", 2))
    ...
    Private Sub drptraffic1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles drptraffic1.SelectedIndexChanged
        If drptraffic1.SelectedValue = 1 Then
            drptraffic2.Enabled = True
...
#End Region
    ...
    Protected Sub drpplyground1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drpplyground1.SelectedIndexChanged
        If drpplyground1.SelectedValue = 1 Then
            drpplyground2.Enabled = True
            txtplaygroundfrom.Enabled = True
            txtplaygroundto.Enabled = True
        ...
        Else
            drpplyground2.Enabled = False
            txtplaygroundfrom.Enabled = False
            txtplaygroundto.Enabled = False
            'cermunpath1.Disabled = True
            HyperLink1.Enabled = False
    ...
    Protected Sub drpaddsec1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drpaddsec1.SelectedIndexChanged
    ...
    Protected Sub drplease1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drplease1.SelectedIndexChanged
        If drplease1.SelectedValue = 1 Then
            drplease2.Enabled = True
            txtleasefrom.Enabled = True
            txtleaseto.Enabled = True
    ...
    Protected Sub drpbuilding1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drpbuilding1.SelectedIndexChanged
        If drpbuilding1.SelectedValue = 1 Then
            drpbuilding2.Enabled = True
            txtbuildingfrom.Enabled = True
            txtbuildingto.Enabled = True
    ...
    Protected Sub drpsketch1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drpsketch1.SelectedIndexChanged
        If drpsketch1.SelectedValue = 1 Then
            drpsketch2.Enabled = True
            txtsketchfrom.Enabled = True
            txtsketchto.Enabled = True
        ...
        Else
            drpsketch2.Enabled = False
            txtsketchfrom.Enabled = False
            txtsketchto.Enabled = False
            'cermunpath1.Disabled = False
            Hyperlink5.Enabled = False
    ...
    Protected Sub drppp1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drppp1.SelectedIndexChanged
        If drppp1.SelectedValue = 1 Then
            drppp2.Enabled = True
            txtppfrom.Enabled = True
            txtppto.Enabled = True
        ...
        Else
            drppp2.Enabled = False
            txtppfrom.Enabled = False
    ...
    Protected Sub drpOF1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drpOF1.SelectedIndexChanged
        ...
        Else
            drpOF2.Enabled = False
            txtOFfrom.Enabled = False
            txtOFto.Enabled = False
            'cermunpath1.Disabled = False
    ...
    Protected Sub drpST1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drpST1.SelectedIndexChanged
        If drpST1.SelectedValue = 1 Then
            drpST2.Enabled = True
            txtSTfrom.Enabled = True
    ...
    Protected Sub drpAmount1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles drpAmount1.SelectedIndexChanged
        If drpAmount1.SelectedValue = 1 Then
            drpAmount2.Enabled = True
            txtAmountfrom.Enabled = True
            txtAmountto.Enabled = True
