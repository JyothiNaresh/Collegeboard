...
'   OBJECTIVE                         : Board Enrollment List
'                                       
'                                       
'   AUTHOR                            : I.CHANDRA
'   INITIAL BASELINE DATE             : 01-Jan-2010
    ...
    Private Sub ExamBranch_Region_Zone_Fill()
        Try
            ...
            ElseIf rdbDos.Checked Then '''THIS FOR D.Os SELECT
                ...
                dsERZ = objReport.Exam_UserWise_Vcs(Session("USERSLNO"), Session("COMACADEMICSLNO"))
                ...
                dsERZ = objReport.Exam_UserVcWise_ExamBranch(drpRZ.SelectedValue, Session("USERSLNO"), Session("COMACADEMICSLNO"))
        ...
        Try
            ...
            If drpFormat.SelectedValue = 1 Then
                DTStudent = " SELECT DISTINCT ADM.ADMSLNO,ADM.ADMNO,ADM.NAME,ADM.NAME||'.'||ADM.SURNAME STUDENTNAME,ADM.FATHERNAME,BRD.PRV_HTNO,ADM.GENDER,CST.CODE COMCODE, " & _
                            " ADM.EXAMBRANCHSLNO,EXAMBRANCH.EXAMBRANCHNAME,ADM.COURSESLNO,ADM.GROUPSLNO,ADM.BATCHSLNO,BRD.BOARDADMSLNO,BRD.BOARDADMNO, " & _
                            " CAT.CODE CATEGORY,ADM.MEDIUMSLNO MEDIUM,'01' ILANG,SEC.CODE IILANG,BC.CODE,BC.BOARDDISTSLNO,BC.BOARDCOLLEGESLNO,BYP.CODE BYPCODE, BYP.BOARDYOPSLNO " & _
                                ...
                                If DRE.Length > 0 Then
                                    For Y As Integer = 0 To LSTSelBoardDist.Items.Count - 1
                                        ...
                                        If DRS.Length > 0 Then
                                            ...
                                            strfile.Append(StrPadding(" ", 39, "L"))
                                            strfile.Append(StrPadding("I.P.E MARCH, 2010 ", 20, "M"))
                                            ...
                                            End If
                                            If ChkBoardAdmNo.Checked = True Then
                                            ...
                                            'strfile.Append(StrPadding("SL.No", 6, "L"))
                                            ''strfile.Append(StrPadding("STUDENT NAME", 30, "L"))
                                            'strfile.Append(StrPadding("Name of the Candidate(in 30 Spaces)" & vbCrLf & "(Capital Letters in Blue ink)", 36, "L"))
                                            'strfile.Append(StrPadding("Name of the Parent(in 25 Spaces)", 34, "L"))
                                            'strfile.Append(StrPadding("PREV", 18, "M"))
                                            'strfile.Append(StrPadding("SEX", 3, "M"))
                                            'strfile.Append(StrPadding("COM-CODE", 9, "M"))
                                            'strfile.Append(StrPadding("CATEGORY", 9, "M"))
                                            'strfile.Append(StrPadding("MEDIUM", 7, "M"))
                                            'strfile.Append(StrPadding("PART-I", 7, "M"))
                                            'strfile.Append(StrPadding("PART-II", 8, "M"))
                                            'strfile.Append(StrPadding("M-1/B", 7, "M"))
                                            'strfile.Append(StrPadding("M-2/Z", 7, "M"))
                                            'strfile.Append(StrPadding("PHY", 6, "M"))
                                            'strfile.Append(StrPadding("CHE", 6, "M"))
                                            'strfile.Append(StrPadding("TOT", 6, "M"))
                                            ...
                                            For S As Integer = 0 To DRE.Length - 1
                                                ...
                                                strfile = strfile.Append(StrPadding(DRE(S)("PRV_HTNO").ToString & "(" & DRE(S)("BYPCODE").ToString & ")", 18, "M") & "|")
                                                ...
                                                strfile = strfile.Append(StrPadding(DRE(S)("MEDIUM").ToString, 7, "M") & "|")
                                                strfile = strfile.Append(StrPadding(DRE(S)("ILANG").ToString, 7, "M") & "|")
                                                strfile = strfile.Append(StrPadding(DRE(S)("IILANG").ToString, 7, "M") & "|")

                                                If DRE(S)("GROUPSLNO") = 1 Then
                        ...
                        If DRC.Length > 0 Then
                            For Y As Integer = 0 To LSTSelBoardDist.Items.Count - 1
                                ...
                                If DRS.Length > 0 Then
                                    ...
                                    strfile.Append(StrPadding("NAME OF THE COLLEGE  : " & BS(1).ToString & "(" & LSTSelBoardCode.Items(i).Text & ")", 79, "L"))
                                    strfile.Append(StrPadding("(" & LstSelCourse.Items(Z).Text & ")", 20, "M"))
                                    'strfile.Append(StrPadding("(1ST YEAR)", 20, "M"))
                                    strfile.Append(StrPadding(" ", 38, "L"))
                                    strfile.Append(StrPadding("COLLEGE CODE  : " & BS(0).ToString, 30, "R") & vbCrLf)
                                    ...
                                    For S As Integer = 0 To DRC.Length - 1
                                        ...
                                        strfile = strfile.Append(StrPadding(DRC(S)("PRV_HTNO").ToString & "(" & DRC(S)("BYPCODE").ToString & ")", 18, "M") & "|")
                                        ...
                                        strfile = strfile.Append(StrPadding(DRC(S)("MEDIUM").ToString, 7, "M") & "|")
                                        strfile = strfile.Append(StrPadding(DRC(S)("ILANG").ToString, 7, "M") & "|")
                                        strfile = strfile.Append(StrPadding(DRC(S)("IILANG").ToString, 7, "M") & "|")

                                        If DRC(S)("GROUPSLNO") = 1 Then
                                            strfile.Append(StrPadding(("31").ToString, 6, "M") & "|")
                                            strfile.Append(StrPadding(("32").ToString, 6, "M") & "|")
                                            strfile.Append(StrPadding(("41").ToString, 6, "M") & "|")
                                            strfile.Append(StrPadding(("42").ToString, 6, "M") & "|")
