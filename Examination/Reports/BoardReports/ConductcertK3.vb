...
Public Class ConductcertK3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CollegeBoard.ConductcertK3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConductcertK3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConductcertK3 = New ConductcertK3()
        rpt.Site = Me.Site
        Return rpt
    End Function
