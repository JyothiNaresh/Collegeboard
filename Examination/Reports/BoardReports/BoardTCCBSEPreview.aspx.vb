Public Class BoardTCCBSEPreview
...
#Region " * Fill Methods"
    ...
    Private Sub FillLables(ByVal ds As DataSet)
        Try
            ...
            lblPoint8b.Text = DsPriview.Tables(0).Rows(0)("DATEOFJOIN").ToString
            ' lblPoint8c.Text = DsPriview.Tables(0).Rows(0)("SECLANG").ToString
            lblPoint8d.Text = DsPriview.Tables(0).Rows(0)("SUBJECTS").ToString()

            lblMedium.Text = DsPriview.Tables(0).Rows(0)("DATEOFLEAVING").ToString()
            lblDoa.Text = DsPriview.Tables(0).Rows(0)("ADMDT").ToString()
            lblAdmyear.Text = DsPriview.Tables(0).Rows(0)("TCISSUEDDATE").ToString()

            'lblPoint12.Text = DsPriview.Tables(0).Rows(0)("POINT11").ToString()
            lblpoint13a.Text = DsPriview.Tables(0).Rows(0)("PRES_DAYS").ToString()

            lblPoint15a.Text = DsPriview.Tables(0).Rows(0)("NCC").ToString()
            lblPoint14a.Text = DsPriview.Tables(0).Rows(0)("WRK_DAYS").ToString()

           

            lblPoint16.Text = DsPriview.Tables(0).Rows(0)("GAMES").ToString()
