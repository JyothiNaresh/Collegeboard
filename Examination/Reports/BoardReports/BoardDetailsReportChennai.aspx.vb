...
'   OBJECTIVE                         : Board Enrollment Details REPORT CHENNAI
'                                       
'                                       
'   AUTHOR                            : I.CHANDRA
'   INITIAL BASELINE DATE             : 20-NOV-2019
...
Public Class BoardDetailsReportChennai
...
#Region "Fill Methods"
    ...
    Private Sub FillExambranch()
        Try
            ...
            DsExambranch = objReport.FillUserWise_ExamBranchChennai(Session("USERSLNO"), Session("COMACADEMICSLNO"))
...
#Region "Sql Query"
    Private Sub GetReportsDetails()
        Try
            ...
            If drpFormat.SelectedValue = 1 Then
                DTStudent = " SELECT DISTINCT ADM.ADMSLNO,ADM.ADMNO,ADM.NAME,ADM.NAME||'.'||ADM.SURNAME STUDENTNAME,ADM.FATHERNAME,BRD.BOARDNAME,BRD.FATHERNAME BOARDFNAME,BRD.MOTHERNAME BOARDMNAME,TO_CHAR(BRD.DOB,'DD/MM/YYYY') DOB,BRD.NATIONALITY,BRD.SCHEDULE_CASTE,BRD.SCHOOL_CLASS, " & _
                            " ADM.EXAMBRANCHSLNO,EXAMBRANCH.EXAMBRANCHNAME,BRANCH.NAME||'-'||BRANCH.BRANCHSLNO ADMBRANCH,ADM.COURSESLNO,COU.NAME COURSE,ADM.GROUPSLNO,GRP.NAME GROUPNAME,ADM.BATCHSLNO,BRD.BOARDADMSLNO,BRD.BOARDADMNO,ADM.AADHAR_NO,BRD.LAST_STUDIED,BRD.BOARD_LASTEXAM, " & _
                            " BRD.TWICE_CLASS,BRD.SUBJECT1,BRD.SUBJECT2,BRD.SUBJECT3,BRD.SUBJECT4,BRD.SUBJECT5,BRD.SUBJECT6,BRD.QUAL_CLASS,BRD.DUES_PAID,BRD.CONCESSION,BRD.TOT_WORKDAYS,WORK_DAYSPRE,BRD.NCC,BRD.GAMES_ACTIV,BRD.CONDUCT,BRD.APPL_CERT,BRD.ISSUE_CERT,BRD.REASON_LEAVING,BRD.OTHER_REMARKS,BC.CODE " & _
                            " FROM T_ADM_DT ADM,T_COURSE_MT COU,EXAM_BOARDSTUDENT_CHENNAI_DT BRD,T_BRANCH_MT ADMBR, " & _
                            " EXAM_EXAMBRANCH EXAMBRANCH,E_USER_BRANCH_ACADEMIC_MT EUA,T_BRANCH_MT BRANCH,EXAM_BOARDCOLLEGE_MT BC, T_GROUP_MT GRP, T_MEDIUM_MT MED, T_ADMSTATUS_MT STA " & _
                            ...
                            " AND ADM.BRANCHSLNO = BRANCH.BRANCHSLNO AND EUA.EXAMBRANCHSLNO=EXAMBRANCH.EXAMBRANCHSLNO  AND ADM.EXAMBRANCHSLNO=EUA.EXAMBRANCHSLNO " & _
                            " AND ADM.GROUPSLNO=GRP.GROUPSLNO AND ADM.MEDIUMSLNO=MED.MEDIUMSLNO AND ADM.STATUS=STA.STATUS AND BRD.ADMBRANCHSLNO=ADMBR.BRANCHSLNO(+) AND ADM.COMACADEMICSLNO= " & Session("COMACADEMICSLNO") & " " & FilterString & " ORDER BY " & Ord
                ...
                If DRW.Length > 0 Then
                    For Z As Integer = 0 To LstSelCourse.Items.Count - 1
                        ...
                        If DRE.Length > 0 Then
                            ...
                            strfile.Append(StrPadding(" <* Central Board Of Secondary Education, Chennai * >", iReportWidth, "M") & vbCrLf)
                            strfile.Append(StrPadding(" <* NOMINAL ROLL * >", iReportWidth, "M") & vbCrLf)

                            strfile.Append(StrPadding(" ", 124, "L"))
                            strfile.Append(StrPadding("I.P.E MARCH, 2020 (CHENNAI) ", 50, "M") & vbCrLf)
                            ...
                            StrHead1 &= StrPadding("Father Name(Board)", 36, "L") & "|"
                            StrHead1 &= StrPadding("Mother Name(Board)", 36, "L") & "|"
                            StrHead1 &= StrPadding("Dob", 10, "M") & "|"
                            StrHead1 &= StrPadding("Adm Class", 12, "M") & "|"
                            StrHead1 &= StrPadding("Nationality", 12, "M") & "|"
                            StrHead1 &= StrPadding("Caste/Tribe", 14, "M") & "|"
                            StrHead1 &= StrPadding("Last Studied", 12, "M") & "|"
                            StrHead1 &= StrPadding("Board LastExam", 15, "M") & "|"
                            StrHead1 &= StrPadding("Twice Class", 12, "M") & "|"
                            StrHead1 &= StrPadding("SUBJECT1", 15, "L") & "|"
                            StrHead1 &= StrPadding("SUBJECT2", 15, "L") & "|"
                            StrHead1 &= StrPadding("SUBJECT3", 15, "L") & "|"
                            StrHead1 &= StrPadding("SUBJECT4", 15, "L") & "|"
                            StrHead1 &= StrPadding("SUBJECT5", 15, "L") & "|"
                            StrHead1 &= StrPadding("SUBJECT6", 15, "L") & "|"
                            StrHead1 &= StrPadding("Qual Class", 15, "L") & "|"
                            StrHead1 &= StrPadding("Dues Paid", 15, "L") & "|"
                            StrHead1 &= StrPadding("Concession", 15, "L") & "|"
                            StrHead1 &= StrPadding("Tot WorkDays", 15, "L") & "|"
                            StrHead1 &= StrPadding("Work Days Pre", 15, "L") & "|"
                            StrHead1 &= StrPadding("NCC/SCOUT", 15, "L") & "|"
                            StrHead1 &= StrPadding("Games Activity", 15, "L") & "|"
                            StrHead1 &= StrPadding("Conduct", 15, "L") & "|"
                            StrHead1 &= StrPadding("Date of Appl Cert", 20, "L") & "|"
                            StrHead1 &= StrPadding("Issue of Cert", 15, "L") & "|"
                            StrHead1 &= StrPadding("Reason for Leaving", 30, "L") & "|"
                            StrHead1 &= StrPadding("Remarks", 50, "L") & "|"
                            StrHead1 &= StrPadding("Admno", 10, "L") & "|"
                            StrHead1 &= StrPadding("COURSE", 10, "M") & "|"
                            StrHead1 &= StrPadding("GROUP", 7, "M") & "|"
                            StrHead1 &= StrPadding("BOARD BRANCH", 30, "L") & "|"
                            StrHead1 &= StrPadding("ADM BRANCH", 30, "L") & "|"
                            StrHead1 &= vbCrLf
                            ...
                            For S As Integer = 0 To DRE.Length - 1
                                ...
                                strfile = strfile.Append(StrPadding(DRE(S)("BOARDFNAME").ToString, 36, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("BOARDMNAME").ToString, 36, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("DOB").ToString, 10, "M") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("SCHOOL_CLASS").ToString, 12, "M") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("NATIONALITY").ToString, 12, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("SCHEDULE_CASTE").ToString, 14, "M") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("LAST_STUDIED").ToString, 12, "M") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("BOARD_LASTEXAM").ToString, 15, "M") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("TWICE_CLASS").ToString, 12, "M") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("SUBJECT1").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("SUBJECT2").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("SUBJECT3").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("SUBJECT4").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("SUBJECT5").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("SUBJECT6").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("QUAL_CLASS").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("DUES_PAID").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("CONCESSION").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("TOT_WORKDAYS").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("WORK_DAYSPRE").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("NCC").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("GAMES_ACTIV").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("CONDUCT").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("APPL_CERT").ToString, 20, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("ISSUE_CERT").ToString, 15, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("REASON_LEAVING").ToString, 30, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("OTHER_REMARKS").ToString, 50, "L") & "|")
                                strfile = strfile.Append(StrPadding(DRE(S)("ADMNO").ToString, 10, "M") & "|")
                                ...
                                strfile = strfile.Append(StrPadding(DRE(S)("EXAMBRANCHNAME").ToString, 30, "L") & "|")
                ...
                If DRW.Length > 0 Then
                    For Z As Integer = 0 To LstSelCourse.Items.Count - 1
                        ...
                        If DRE.Length > 0 Then
                            ...
                            StrHead1 &= StrPadding("Board Code,", 11, "L")
                            StrHead1 &= StrPadding("Aadhar No,", 10, "L")
                            StrHead1 &= StrPadding("Student Name,", 13, "L")
                            StrHead1 &= StrPadding("Father Name,", 12, "L")
                            StrHead1 &= StrPadding("Student Name(Board),", 20, "L")
                            StrHead1 &= StrPadding("Father Name(Board),", 20, "L")
                            StrHead1 &= StrPadding("Mother Name(Board),", 20, "L")
                            StrHead1 &= StrPadding("Dob,", 4, "L") & "|"
                            StrHead1 &= StrPadding("Adm Class,", 10, "L")
                            StrHead1 &= StrPadding("Nationality,", 12, "L")
                            StrHead1 &= StrPadding("Caste/Tribe,", 12, "L")
                            StrHead1 &= StrPadding("Last Studied,", 13, "L")
                            StrHead1 &= StrPadding("Board LastExam,", 15, "L")
                            StrHead1 &= StrPadding("Twice Class,", 12, "L")
                            StrHead1 &= StrPadding("Subject1,", 9, "L")
                            StrHead1 &= StrPadding("Subject2,", 9, "L")
                            StrHead1 &= StrPadding("Subject3,", 9, "L")
                            StrHead1 &= StrPadding("Subject4,", 9, "L")
                            StrHead1 &= StrPadding("Subject5,", 9, "L")
                            StrHead1 &= StrPadding("Subject6,", 9, "L")
                            StrHead1 &= StrPadding("Qual Class,", 11, "L")
                            StrHead1 &= StrPadding("Dues Paid,", 10, "L")
                            StrHead1 &= StrPadding("Concession,", 11, "L")
                            StrHead1 &= StrPadding("Tot WorkDays,", 13, "L")
                            StrHead1 &= StrPadding("Work Days Pre,", 14, "L")
                            StrHead1 &= StrPadding("NCC/SCOUT,", 10, "L")
                            StrHead1 &= StrPadding("Games Activity,", 15, "L")
                            StrHead1 &= StrPadding("Conduct,", 8, "L")
                            StrHead1 &= StrPadding("Date of Appl Cert,", 18, "L")
                            StrHead1 &= StrPadding("Issue of Cert,", 14, "L")
                            StrHead1 &= StrPadding("Reason for Leaving,", 19, "L")
                            StrHead1 &= StrPadding("Remarks,", 8, "L")
                            StrHead1 &= StrPadding("Admno,", 6, "L")
                            StrHead1 &= StrPadding("Course,", 7, "L")
                            StrHead1 &= StrPadding("Group,", 7, "L")
                            ...
                            For S As Integer = 0 To DRE.Length - 1
                                ...
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile.Append(StrPadding(DRE(S)("AADHAR_NO").ToString, 12, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("STUDENTNAME").ToString, 36, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("FATHERNAME").ToString, 34, "L"))
                                ...
                                strfile = strfile.Append(StrPadding(DRE(S)("BOARDMNAME").ToString, 36, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("DOB").ToString, 10, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("SCHOOL_CLASS").ToString, 12, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("NATIONALITY").ToString, 12, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("SCHEDULE_CASTE").ToString, 14, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("LAST_STUDIED").ToString, 12, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("BOARD_LASTEXAM").ToString, 15, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("TWICE_CLASS").ToString, 12, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("SUBJECT1").ToString, 15, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("SUBJECT2").ToString, 15, "L"))
                                ...
                                strfile = strfile.Append(StrPadding(DRE(S)("CONDUCT").ToString, 15, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("APPL_CERT").ToString, 15, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("ISSUE_CERT").ToString, 15, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("REASON_LEAVING").ToString, 30, "LM"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("OTHER_REMARKS").ToString, 50, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                ...
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("GROUPNAME").ToString, 10, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("EXAMBRANCHNAME").ToString, 30, "L"))
                                strfile.Append(StrPadding(",", 1, "M"))
                                strfile = strfile.Append(StrPadding(DRE(S)("ADMBRANCH").ToString, 30, "L"))
