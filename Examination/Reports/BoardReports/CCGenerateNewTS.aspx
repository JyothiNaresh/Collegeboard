<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CCGenerateNewTS.aspx.vb" Inherits="CollegeBoard.CCGenerateNewTS" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" onload="pageset();">
		<form id="Form1" method="post" runat="server">
			<TABLE style="Z-INDEX: 102; POSITION: absolute; TOP: 8px; LEFT: 8px" id="Table4" border="0"
											...
											<TD style="HEIGHT: 120px" align="center">
												<P>
													...
													<asp:label id="Label36" runat="server" Height="9px" Width="100%" Font-Size="Smaller" Font-Names="Calibri"
														CssClass="lables">( Recognised by Govt. of Telangana - Affiliated to BIE ,Telangana )</asp:label>
