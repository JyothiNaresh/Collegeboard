...
#Region "FillMethods"
    ...
    Private Sub SearchingData()
        Try
            ...
            dsResult = objBE.P_DTCSTUDENTS_SELECT(Session("COMACADEMICSLNO"), DrpExamBranch.SelectedValue, DrpBoardCollege.SelectedValue, TxtSelect.Text)
...
#End Region
    ...
    Private Sub dgGrid_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgGrid.DeleteCommand
        Try
            ...
            Response.Redirect("BoardTCReport.aspx?UNIQUENO=" & dgGrid.Items(e.Item.ItemIndex).Cells(0).Text.ToString & "&BOARDCOLLEGESLNO=" & dgGrid.Items(e.Item.ItemIndex).Cells(1).Text.ToString & "&FLAG=" & Session("FLAG"))
