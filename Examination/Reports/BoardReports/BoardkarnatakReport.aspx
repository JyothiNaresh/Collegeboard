<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BoardkarnatakReport.aspx.vb" Inherits="CollegeBoard.BoardkarnatakReport" %>
					...
					<TD>
						<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="100%" border="1" runat="server">
							...
							<TR>
								...
								<TD width="20%">
                                    <asp:dropdownlist id="DrpCourse" runat="server" Width="120px"  CssClass=" ">

                                    <asp:ListItem Value="1">XI</asp:ListItem>
                                    <asp:ListItem Value="2">XII</asp:ListItem>
                                     <asp:ListItem Value="3" Selected="True">XI-XII</asp:ListItem>
								     </asp:dropdownlist>
