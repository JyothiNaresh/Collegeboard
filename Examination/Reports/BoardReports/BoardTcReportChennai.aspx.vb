...
Public Class BoardTcReportChennai
...
#Region "FillMethods"
    ...
    Private Sub SearchingData()
        Try
            ...
            dsResult = objBE.P_DTCSTUDENTS_SELECTChennai(Session("COMACADEMICSLNO"), DrpExamBranch.SelectedValue, DrpBoardCollege.SelectedValue, TxtSelect.Text)
...
#Region "Grid Events"
    ...
    Private Sub dgGrid_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgGrid.DeleteCommand
        Try
            ...
            '    Response.Redirect("BoardTCReportMumbai.aspx?ADMSLNO=" & dgGrid.Items(e.Item.ItemIndex).Cells(1).Text.ToString & "&UNIQUENO=" & dgGrid.Items(e.Item.ItemIndex).Cells(0).Text.ToString & "&BOARDCOLLEGESLNO=" & dgGrid.Items(e.Item.ItemIndex).Cells(2).Text.ToString & "&FLAG=" & Session("FLAG"))
            'End If
            Response.Redirect("TcGenerateChennai.aspx?ADMSLNO=" & dgGrid.Items(e.Item.ItemIndex).Cells(1).Text.ToString & "&UNIQUENO=" & dgGrid.Items(e.Item.ItemIndex).Cells(0).Text.ToString & "&BOARDCOLLEGESLNO=" & dgGrid.Items(e.Item.ItemIndex).Cells(2).Text.ToString & "&FLAG=" & Session("FLAG"))
