...
Public Class SchConductcertK3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CollegeBoard.SchConductcertK3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSchConductcertK3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SchConductcertK3 = New SchConductcertK3()
        rpt.Site = Me.Site
        Return rpt
    End Function
