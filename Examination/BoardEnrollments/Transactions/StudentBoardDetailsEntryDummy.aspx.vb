...
Public Class StudentBoardDetailsEntryDummy
...
#Region "Fill Methods"
    ...
    End Sub
    Private Sub MediumFill()
        Dim Ds As DataSet
        Ds = ClsUty.DataSet_OneFetch("SELECT  NAME,MEDIUMSLNO  FROM T_MEDIUM_MT    ORDER BY MEDIUMSLNO ASC")
...
#Region "Methods"
    ...
    Private Function SetEntries() As ArrayList
        ...
        Arr.Add(DrpGroup.SelectedItem.Value)                  '--16
        ...
        If DrpMedium.SelectedItem.Value <= 0 Then              '--25
            Arr.Add(System.DBNull.Value)
        Else
            Arr.Add(Trim(DrpMedium.SelectedValue))
        End If

        Arr.Add(drpBranchSearch.SelectedItem.Value)    '-- 26
    ...
    Private Function ValidateForm() As Boolean
        Try
            ...
            ElseIf DrpCourse.SelectedValue = 0 Then
                ...
                Return False
            ElseIf DrpMedium.SelectedValue = 0 Then
                StartUpScript(DrpMedium.ID, " Select Medium ")
                Return False
            End If
...
#Region "Button Events"
    ...
    Private Sub iBtnSearch_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSearch.Click
        Try
            ...
            BrdStu = New ClsBoardEnrollment
            Ds = BrdStu.GetDataForStudentDummy(drpBranchSearch.SelectedValue, Session("COMACADEMICSLNO"))
    ...
    Private Sub iBtnSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSave.Click
        Try
            ...
            BrdStu = New ClsBoardEnrollment
            RtnValue = BrdStu.Student_InsertDummy(SetEntries())
            If RtnValue = 1 Then
