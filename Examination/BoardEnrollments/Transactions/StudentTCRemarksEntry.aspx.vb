...
'   OBJECTIVE                         : This is the Student TC Remarks Entry
'   AUTHOR                            : CHANDRA
'   INITIAL BASELINE DATE             : 03-APR-2013
'   MODIFICATIONS LOG                 : By Srikanth Reddy 19/09/2013(Updated RequestedUserSlno)
'----------------------------------------------------------------------------------------------
Imports CollegeBoardDLL
Public Class StudentTCRemarksEntry
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents dgTCRequest As System.Web.UI.WebControls.DataGrid
...
#Region "Fill Methods"
    ...
    Private Sub FillControls(ByVal Ds As DataSet)
        Try
            ...
            TxtRemarks.Text = IIf(IsDBNull(Ds.Tables(0).Rows(0)("TCREMARK")), "", Ds.Tables(0).Rows(0)("TCREMARK"))
    ...
    Private Sub fillDrpCourse()
        ...
        Dim Ds As DataSet
        BrdStu = New ClsBoardEnrollment
        Ds = BrdStu.Masters_Selectall(15)
    ...
    Private Sub FillRequestGrid()
        Try
            Dim Ds As DataSet
            BrdStu = New ClsBoardEnrollment
            Ds = BrdStu.FillUserWise_TcRequest(USERSLNO, Session("COMACADEMICSLNO"))
            dgTCRequest.DataSource = Ds
            dgTCRequest.DataBind()
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
...
#Region "Methods"
    ...
    Private Function SetEntries() As ArrayList
        ...
        Arr.Add(ViewState("UNIQUENO"))                  '--0

        If Trim(TxtRemarks.Text) = "" Then              '--1
        ...
        'Arr.Add(Session("COMACADEMICSLNO"))             '--2
    ...
    Private Function ValidateForm() As Boolean
        Try
            If TxtRemarks.Text.Trim = "" Then
                StartUpScript(TxtRemarks.ID, " Enter TC Remark")
                Return False
            End If
...
#Region "Button Events"
    ...
    Private Sub iBtnSearch_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSearch.Click
        Try
            ...
            End If
            BrdStu = New ClsBoardEnrollment
            Ds = BrdStu.TCGetDataForStudent(txtAdmNoSearch.Text, drpBranchSearch.SelectedValue, Session("COMACADEMICSLNO"))
    ...
    Private Sub iBtnSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSave.Click
        Try
            ...
            BrdStu = New ClsBoardEnrollment
            RtnValue = BrdStu.TCStudent_Update(SetEntries())
            If RtnValue = 1 Then
