...
Public Class StudentBoardDetailsEntryNonAdmitted
...
#Region "Fill Methods"
    ...
    Private Sub FillControlsNonAdmitted(ByVal Ds As DataSet)
        Try
...
#Region "Button Events"
    ...
    Private Sub iBtnSearch_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSearch.Click
        Try
            ...
            End If
            BrdStu = New ClsBoardEnrollment
            Ds = BrdStu.GetDataForStudent_NA(txtAdmNoSearch.Text, drpBranchSearch.SelectedValue, Session("COMACADEMICSLNO"))
    ...
    Private Sub iBtnSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSave.Click
        Try
            ...
            BrdStu = New ClsBoardEnrollment
            RtnValue = BrdStu.StudentNonAdmitted_Update(SetEntries())
            If RtnValue = 1 Then
