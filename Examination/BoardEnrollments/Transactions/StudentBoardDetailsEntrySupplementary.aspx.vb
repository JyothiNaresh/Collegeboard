...
Public Class StudentBoardDetailsEntrySupplementary
...
#Region " Web Form Designer Generated Code "
    ...
    Protected WithEvents DropdownAcdamic As System.Web.UI.WebControls.DropDownList
...
#Region "Methods"
    ...
    Private Function SetEntries() As ArrayList
        ...
        If DropdownAcdamic.SelectedValue <= 0 Then
            Arr.Add(System.DBNull.Value)
        Else
            Arr.Add(Trim(DropdownAcdamic.SelectedValue))
        End If
...
#Region "Button Events"
    ...
    Private Sub iBtnSearch_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSearch.Click
        Try
            Dim Ds As DataSet
            ClearControls(1)
            Session("COMACADEMICSLNO") = DropdownAcdamic.SelectedValue
            ...
            If Not Ds Is Nothing Then
                If Ds.Tables(0).Rows.Count > 0 Then
                    ...
                    'Response.Write("<script language=Javascript>alert('Student found.')</script>")
    ...
    Private Sub iBtnSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSave.Click
        Try
            ...
            BrdStu = New ClsBoardEnrollment
            RtnValue = BrdStu.StudentSupply_Update(SetEntries())
            If RtnValue = 1 Then
