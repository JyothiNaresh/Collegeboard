...
'   ACTIVITY                          : Many To Many Users Wise Staff Combination Key
...
Public Class StaffUserWiseCombinationkey
...
#Region "Fill Methods"
    ...
    Private Sub FillCombinationKeys()
        Try
            ...
            If drpAcaSlno.SelectedIndex <> -1 Then
                dsBranch = ClsUty.DataSet_Fetch(" SELECT A.SLNO,A.EXAMNAME FROM STAFF_EXAMNAME A, " & _
                      " STAFF_ACCCOMBKEY_DT B WHERE A.SLNO=B.COMBINATIONKEY AND B.COMACADEMICSLNO=" & drpAcaSlno.SelectedValue.ToString & " ORDER BY A.EXAMNAME ")
...
#Region "Button Events"
    ...
    Private Sub ibtSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibtSave.Click
        Try
            If PageValidations() Then
                ...
                RtnStr = objUscls.Staff_UserCombinationKey_Save(SetEntriesBranch())
    ...
    Private Sub ibtnCancel_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibtnCancel.Click
        Try
            Response.Redirect("../Security/StaffUserCombikeyView.aspx?USERTYPESLNO=" & DrpUserTypes.SelectedValue.ToString)
        Catch Oex As OracleException
            StartUpScript("", DataBaseErrorMessage(Oex.Message))
        Catch ex As Exception
            If GeneralErrorMessage(ex.Message) <> "" Then
