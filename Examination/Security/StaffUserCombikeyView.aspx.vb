...
'   ACTIVITY                          : User Wise Staff Combination key  View
'   AUTHOR                            : A.Surendar Reddy
'   INITIAL BASELINE DATE             : 25-Aug-2008
'   FINAL BASELINE DATE               : 25-Aug-2008
'   MODIFICATIONS LOG                 : Nil
'----------------------------------------------------------------------------------------------
Imports CollegeBoardDLL
Imports System.Data.OracleClient
Public Class StaffUserCombikeyView
...
#Region "Fill Methods"
    ...
    Private Function FilldataGrid(ByVal PageIndex)
        Try
            ...
            Dim SqlStr As String = "SELECT UC.USERSLNO,UC.COMACADEMICSLNO,UC.COMBINATIONKEY,EM.EXAMNAME FROM STAFF_USERCOMBINATIONKEY_MT UC,STAFF_EXAMNAME EM " & _
    ...
    Private Sub dgVusers_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgVusers.DeleteCommand
        Try
            ...
            If UserSlno = 1 Then
                ...
                Exit Sub
            End If
            RtnStr = objUcls.Staff_UserCombinationKey_Delete(UserSlno, Val(dgVusers.Items(e.Item.ItemIndex).Cells(2).Text), Val(dgVusers.Items(e.Item.ItemIndex).Cells(3).Text))
            If RtnStr = 1 Then
                FilldataGrid(0)
...
#Region "Image Buttons"
    ...
    Private Sub ibtnSingle_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ibtnSingle.Click
        Try
            Response.Redirect("StaffUserWiseCombinationkey.aspx?USERTYPESLNO=" & DrpUserTypes.SelectedValue.ToString)
        Catch Oex As OracleException
            StartUpScript("", DataBaseErrorMessage(Oex.Message))
        Catch ex As Exception
            If GeneralErrorMessage(ex.Message) <> "" Then
