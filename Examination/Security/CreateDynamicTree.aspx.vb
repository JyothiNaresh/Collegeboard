...
'   OBJECTIVE                         : This is Presentation Layer For DynamicTree
'   ACTIVITY                          : DynamicTreeView
'   AUTHOR                            : Srikanth
...
Public Class CreateDynamicTree
        ...
        Try
            ...
            For Each dr In Dv
                If dr("isparent") = 0 Then
                    Nodes.Add(NodeCreation(dr("nodecaption"), dr("idnode"), False, "CreateNodes.aspx?parId=" & dr("idnode") & "&parNode=" & dr("nodecaption") & "&IdparNode=" & dr("idparentnode")))
                Else
