...
'   OBJECTIVE                         : This is Presentation Layer For TreeNodes Creation
'   ACTIVITY                          : Nodes Creation
'   AUTHOR                            : Srikanth
...
#Region "Class Variables"
    ...
    Private maxid, idParNode, parid, nodeType As Integer
    ...
    Private Sub iBtnSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles iBtnSave.Click
        Try
            ...
            If Not Filepath = "" Then
                ...
                Filepath = Filepath.Replace("C:/Inetpub/wwwroot/COLLEGEBOARD/Examination", "..")
            End If

            '  ds = objUcls.GetMaxNode()
            ' maxid = ds.Tables(0).Rows(0)("maxid")
            idParNode = Request.QueryString("idparnode")
            parid = Request.QueryString("parid")
            objUcls.insertMaxNode(parid, nodeDesc, nodeType, Filepath)
            Response.Write("<script language=Javascript>Javascript:window.open('../Html/Content.aspx','_top');</script>")
