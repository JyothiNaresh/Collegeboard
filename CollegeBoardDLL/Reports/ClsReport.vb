...
'   INITIAL BASELINE DATE             : 08-AUG-2006
'   FINAL BASELINE DATE               : 08-AUG-2006
...
#Region "CommFillMethods"
    ...
    Public Function GetSubTotalRank(ByVal iDTStudent As String, ByVal iDTTotal As String, ByVal iDTSubjects As String, ByVal iDTAvgRank As String, ByVal iDTESTAvgRank As String, ByVal iDtTotalStu As String) As DataSet
        Try
            ...
            oParameter = oCommand.Parameters.Add("iDTStudent", OracleType.VarChar, 9000)
            oParameter.Direction = ParameterDirection.Input
            oParameter.Value = iDTStudent

            oParameter = oCommand.Parameters.Add("iDTTotal", OracleType.VarChar, 9000)
            oParameter.Direction = ParameterDirection.Input
            ...
            oParameter = oCommand.Parameters.Add("iDtTotalStu", OracleType.VarChar, 9000)
            oParameter.Direction = ParameterDirection.Input
...
#Region "Rrevious Course Marks Range"
    ...
    Public Function PcmRange_Save(ByVal dsRANGE As DataSet, ByVal DtTable As String) As String
        Try
            ...
            oParameter = iCommand.Parameters.Add("iFROMNO", OracleType.Float)
            oParameter.Direction = ParameterDirection.Input
            oParameter.SourceColumn = "FROMNO"

            oParameter = iCommand.Parameters.Add("iTONO", OracleType.Float)
            oParameter.Direction = ParameterDirection.Input
            ...
            oParameter = oCommand.Parameters.Add("iFROMNO", OracleType.Float)
            oParameter.Direction = ParameterDirection.Input
            oParameter.SourceColumn = "FROMNO"

            oParameter = oCommand.Parameters.Add("iTONO", OracleType.Float)
            oParameter.Direction = ParameterDirection.Input
            oParameter.SourceColumn = "TONO"
...
#Region " Course Marks Range "
    ...
    Public Function CMRange_Save(ByVal dsRANGE As DataSet, ByVal DtTable As String) As String
        Try
            ...
            oParameter = iCommand.Parameters.Add("iRANGETARGET", OracleType.Float)
            oParameter.Direction = ParameterDirection.Input
            oParameter.SourceColumn = "RANGETARGET"

            oParameter = iCommand.Parameters.Add("iCUMMTARGET", OracleType.Float)
            oParameter.Direction = ParameterDirection.Input
            oParameter.SourceColumn = "CUMMTARGET"
            ...
            oParameter = oCommand.Parameters.Add("iRANGETARGET", OracleType.Float)
            oParameter.Direction = ParameterDirection.Input
            oParameter.SourceColumn = "RANGETARGET"

            oParameter = oCommand.Parameters.Add("iCUMMTARGET", OracleType.Float)
            oParameter.Direction = ParameterDirection.Input
            oParameter.SourceColumn = "CUMMTARGET"
...
#Region " CourseSubject Marks Range"

    Public Function CRSubjectMRange_Select(ByVal dsRANGE As DataSet, ByVal DtTable As String, ByVal COURSESLNO As Integer, ByVal SUBJECTSLNO As Integer, ByVal RANGEFOR As Integer) As DataSet
        Try
            oAdapter = New OracleClient.OracleDataAdapter
            ObjConn = New Connection
            oConn = ObjConn.GetConnection 'establishing the Connection .
            ...
            oCommand.CommandText = "EXAM_CRSUBJMRKR_SELECT"
            oCommand.CommandType = CommandType.StoredProcedure
            oCommand.Connection = oConn
    ...
    Public Function CRSubjectMRange_Save(ByVal dsRANGE As DataSet, ByVal DtTable As String) As String
        Try
            oAdapter = New OracleClient.OracleDataAdapter
            ObjConn = New Connection
            oConn = ObjConn.GetConnection 'establishing the Connection .
            ...
            iCommand.CommandText = "EXAM_CRSUBJMRKR_INSERT"
            iCommand.CommandType = CommandType.StoredProcedure
            iCommand.Connection = oConn
            iCommand.Transaction = oTrans

            oCommand.CommandText = "EXAM_CRSUBJMRKR_UPDATE"
            oCommand.CommandType = CommandType.StoredProcedure
            oCommand.Connection = oConn
            oCommand.Transaction = oTrans
...
#Region " Result Module Marks Range "
    ...
    Public Function RmRange_Select(ByVal dsRANGE As DataSet, ByVal DtTable As String, ByVal RESLNO As Integer, ByVal RANGEFOR As Integer) As DataSet
        Try
            oAdapter = New OracleClient.OracleDataAdapter
            ObjConn = New Connection
            oConn = ObjConn.GetConnection 'establishing the Connection .
    ...
    Public Function RmRange_Save(ByVal dsRANGE As DataSet, ByVal DtTable As String) As String
        Try
            ...
            oParameter = iCommand.Parameters.Add("iRESLNO", OracleType.Number)
            oParameter.Direction = ParameterDirection.Input
