...
'   OBJECTIVE                         : This is the ComboBox Filling
'   ACTIVITY                          : 
...
Public Class ClsComboBoxFilling
...
#Region "First Degree"
    ...
    Public Function EXAMBranchWiseCourse_Fetch(ByVal eBranchSLNO As Integer) As Data.DataSet
        ...
        Return Ds
    End Function
    Public Function EXAMBranchWiseCourse_Fetch(ByVal eBranchSLNO As Integer, ByVal eDEXAMSLNO As Integer) As Data.DataSet
        Try
            ObjConn = New Connection
            oConn = ObjConn.GetConnection()
            ...
            oCommand.CommandText = "P_EBWISECOURSE_FILL_MASS"
            oCommand.Connection = oConn
            oCommand.CommandType = CommandType.StoredProcedure
    ...
    Public Function EXAMBranchWiseMedium_Fetch(ByVal eBranchSLNO As Integer) As Data.DataSet
        ...
        Return Ds
    End Function
    Public Function EXAMBranchWiseSubBatch_Fetch(ByVal eBranchSLNO As Integer, ByVal pCourseslno As Integer, ByVal pGroupslno As Integer, ByVal pBatchslno As Integer) As Data.DataSet
        Try
            ObjConn = New Connection
            oConn = ObjConn.GetConnection()
...
#Region "USER WISE FILL"
    ...
    Public Function TCUSERWISEEBAP(ByVal USERSLNO As Integer, ByVal iCOMACADEMICSLNO As Integer) As Data.DataSet
        Try
            ObjConn = New Connection
            oConn = ObjConn.GetConnection()
            ...
            oCommand.CommandText = "TCUSERWISEEBAP"
            oCommand.Connection = oConn
            oCommand.CommandType = CommandType.StoredProcedure
    ...
    Public Function TCUSERWISECBSE(ByVal USERSLNO As Integer, ByVal iCOMACADEMICSLNO As Integer) As Data.DataSet
        Try
            ObjConn = New Connection
            oConn = ObjConn.GetConnection()
            ...
            oCommand.CommandText = "USERWISE_CBSE"
            oCommand.Connection = oConn
            oCommand.CommandType = CommandType.StoredProcedure
    ...
    Public Function TCUSERWISEEBTS(ByVal USERSLNO As Integer, ByVal iCOMACADEMICSLNO As Integer) As Data.DataSet
        Try
            ObjConn = New Connection
            oConn = ObjConn.GetConnection()
            ...
            oCommand.CommandText = "TCUSERWISEEBTS"
            oCommand.Connection = oConn
            oCommand.CommandType = CommandType.StoredProcedure
    ...
    Public Function ACT_USERWISEEB(ByVal COLLEGETYPE As Integer, ByVal USERSLNO As Integer, ByVal iCOMACADEMICSLNO As Integer) As Data.DataSet
        Try
            ObjConn = New Connection
            oConn = ObjConn.GetConnection()
            ...
            oCommand.CommandText = "ACT_USERWISEEB"
            oCommand.Connection = oConn
            oCommand.CommandType = CommandType.StoredProcedure

            'ADD IN PARAMETER NAME COLLEGETYPE (SCHOOL TYPE)
            oParameter = oCommand.Parameters.Add("iCOLLEGETYPE", OracleType.Number)
            oParameter.Direction = ParameterDirection.Input
            oParameter.Value = COLLEGETYPE
        ...
        Return Ds
    End Function
    Public Function USERWISEREGION(ByVal USERSLNO As Integer, ByVal iCOMACADEMICSLNO As Integer) As Data.DataSet
        Try
            ObjConn = New Connection
            oConn = ObjConn.GetConnection()
            ...
            oCommand.CommandText = "USERWISEREGION"
            oCommand.Connection = oConn
            oCommand.CommandType = CommandType.StoredProcedure
...
#End Region
    ...
    Public Function EXAMBranchWiseCourse_Fetch1() As Data.DataSet
        Try
            ObjConn = New Connection
            oConn = ObjConn.GetConnection()
            ...
            oCommand.CommandText = "GK_EBWISECOURSE_FILL"
            oCommand.Connection = oConn
            oCommand.CommandType = CommandType.StoredProcedure
