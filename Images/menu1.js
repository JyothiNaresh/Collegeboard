...
//if (domaincheck.indexOf("http")!=-1&&domaincheck.indexOf("dynamicdrive.com")==-1){
...
function Menu()
{
    ...
    this.addMenuSeparator = addMenuSeparator;//Sudha
    this.menuBorder = 0;//Sudha
	this.menuItemBorder = 0;//Sudha
	this.hideOnMouseOut = true;//Sudha
	lastMenu = null;
	...
	HTMLstr += "\n";
	if (ie||ns6) HTMLstr += "<div id='MainTable' style='position:absolute;top:95;left:0;'>\n";
