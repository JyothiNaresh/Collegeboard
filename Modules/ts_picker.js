...
//var cnTop="270";//top coordinate of calendar window.
//var cnLeft="690";//left coordinate of calendar window
var WindowTitle ="DateTime Picker";//Date Time Picker title.

var WeekChar=2;//number of character for week day. if 2 then Mo,Tu,We. if 3 then Mon,Tue,Wed.
var CellWidth=30;//Width of day cell.
var DateSeparator="/";//Date Separator, you can change it to "/" if you want.
var DateSeparator1="-";//Date Separator, you can change it to "/" if you want.--GK
...
function NewCal(pCtrl,pFormat,pShowTime,pTimeMode,pScroller,pHideSeconds)
{
	...
	if (exDateTime!="")//Parse existing Date String
	{
		...
		//KISHORE ++
		else if ((Cal.Format.toUpperCase()=="MMYYYY") || (Cal.Format.toUpperCase()=="MMMYYYY"))
		{
			if (DateSeparator=="")
			{
				strMonth=exDateTime.substring(2,4+offset);
	...
	selDate=new Date(Cal.Year,Cal.Month);//version 1.7
	//selDate=new Date(Cal.Year,Cal.Month,Cal.Date);//version 1.7
	//winCal=window.open("","DateTimePicker",addressbar=0,toolbar=0,status=0,menubar=no,fullscreen=no,width=230,height=245,resizable=0,top="+cnTop+",left="+cnLeft);
	winCal=window.open("","DateTimePicker",'width=200,height=225,menubar=no,scrollbars=no,toolbar=no,left=690,top=270');
...
function FormatDate(pDate)
{
	...
	if (this.Format.toUpperCase()=="DDMMYYYY")
		...
		return (MonthDigit+DateSeparator+pDate+this.Year);
	else if (this.Format.toUpperCase()=="MMMDDYYYY")
		return (this.GetMonthName(false)+DateSeparator+pDate+DateSeparator+this.Year);
	else if (this.Format.toUpperCase()=="MMMYYYY")
		return (this.GetMonthName(false)+DateSeparator1+this.Year);
