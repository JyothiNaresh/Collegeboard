<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StudentBoardDetailsEntryNonAdmitted.aspx.vb" Inherits="CollegeBoard.StudentBoardDetailsEntryNonAdmitted" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html>
<head>
    <title>StudentBoardDetailsEntryForNonAdmitted</title>
                                                                          ...
                                                                          <%-- 
                                                                            ...
                                                                            <td height="13">
                                                                                <asp:DropDownList ID="DropdownAcdamic" runat="server" Width="100px" CssClass="textboxASR" AutoPostBack="True">
                                                                                    <asp:ListItem Value="12" Selected="True">2017-2018</asp:ListItem>
                                                                            ...
                                                                            <td class="FormNoLable" valign="middle" nowrap="nowrap" align="center" width="31%">
                                                                                <asp:Label ID="LblAdmNoSearch" runat="server" Width="72px" CssClass="Lables">Board&nbsp;AdmNo *</asp:Label></td>
                                                                            <td width="132">
                                                                            ...
                                                                            <td width="17%">
                                                                                <asp:DropDownList ID="drpBranchSearch" runat="server" Width="200px" CssClass="textboxASR"></asp:DropDownList></td>
                                                                            <td width="17%">
