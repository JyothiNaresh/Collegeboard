<%@ Page Language="vb" AutoEventWireup="false" Codebehind="UserWiseCombinationkey.aspx.vb" Inherits="CollegeBoard.UserWiseCombinationkey" %>
							...
							<TR>
								<TD vAlign="baseline" nowrap="nowrap" align="center">
									<TABLE id="Table2" style="WIDTH: 881px; HEIGHT: 312px" cellSpacing="0" cellPadding="1"
										...
										<TR>
											<TD vAlign="middle" align="center"><asp:label id="lblHeading" runat="server" CssClass="SubHeading1" Width="100%">User Wise Combination Key</asp:label></TD>
										</TR>
										<TR>
										...
										<TR>
											<TD style="HEIGHT: 24px" vAlign="middle" align="center">
												<HR width="100%" SIZE="1">
												<asp:checkbox style="Z-INDEX: 0" id="chkAreaTypes" runat="server" CssClass="Lables" Text="Area Types"
													AutoPostBack="True"></asp:checkbox>
											</TD>
										</TR>
										<TR>
											<TD style="HEIGHT: 24px" vAlign="middle" align="center">
												<asp:checkboxlist style="Z-INDEX: 0" id="chklAreaType" runat="server" Width="100%" CssClass="Lables"
													RepeatColumns="6"></asp:checkboxlist></TD>
										</TR>
										<TR>
											<TD style="HEIGHT: 24px" vAlign="middle" align="center">
												<asp:imagebutton accessKey="G" style="Z-INDEX: 0" id="ibtGo" runat="server" Width="40px" CssClass="button"
													ImageUrl="../../Images/NewImages/go.gif" Height="20px" BorderStyle="None"></asp:imagebutton></TD>
										</TR>
										<TR>
