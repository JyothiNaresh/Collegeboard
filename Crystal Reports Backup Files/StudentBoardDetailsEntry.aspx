<%@ Page Language="vb" AutoEventWireup="false" Codebehind="StudentBoardDetailsEntry.aspx.vb" Inherits="CollegeBoard.StudentBoardDetailsEntry" %>
																	...
																	<TD align="right" width="25%">
																		<TABLE style="WIDTH: 161px; HEIGHT: 24px" cellSpacing="0" cellPadding="0" width="161" border="0">
																			<TR>
																				...
																				<TD width="132"><asp:textbox id="txtAdmNoSearch" runat="server" Width="56px" CssClass="textboxASR" MaxLength="4"></asp:textbox></TD>
													...
													<TR>
														<TD class="TableBorder" vAlign="top">
															<TABLE id="Table3" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<TR>
																	<TD style="WIDTH: 78px"><asp:label id="Label3" runat="server" Width="80px" CssClass="LABLES">SurName</asp:label></TD>
																...
																<TR>
																	<TD style="WIDTH: 78px"><asp:label id="Label4" runat="server" Width="80px" CssClass="LABLES">Code</asp:label></TD>
													...
													<TR>
														<TD class="TableBorder" vAlign="top">
															<TABLE id="Table5" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<TR>
																	<TD style="WIDTH: 78px; HEIGHT: 8px"><asp:label id="Label25" runat="server" Width="100%" CssClass="LABLES" Enabled="False">District</asp:label></TD>
																	<TD style="WIDTH: 127px; HEIGHT: 8px"><asp:dropdownlist id="DrpDist" runat="server" Width="100%" CssClass="textboxASR" Enabled="False"></asp:dropdownlist></TD>
																	<TD style="WIDTH: 98px; HEIGHT: 8px"><asp:label id="Label26" runat="server" Width="100%" CssClass="LABLES">Code-College</asp:label></TD>
																	<TD style="WIDTH: 97px; HEIGHT: 8px" colSpan="3"><asp:dropdownlist id="DrpColl" runat="server" Width="530px" CssClass="textboxASR"></asp:dropdownlist></TD>
																</TR>
																<TR>
																	<TD style="WIDTH: 78px"><asp:label id="Label7" runat="server" Width="100%" CssClass="LABLES" Enabled="False">Board&nbsp;ID</asp:label></TD>
																	<TD style="WIDTH: 127px"><asp:textbox id="TxtBid" runat="server" Width="100%" CssClass="textboxASR" MaxLength="5" ReadOnly="True"
																			Enabled="False"></asp:textbox></TD>
																	<TD style="WIDTH: 98px"><asp:label id="Label15" runat="server" Width="100%" CssClass="LABLES">Board&nbsp;Adm.No</asp:label></TD>
																...
																<TR>
																	<TD style="WIDTH: 78px"><asp:label id="Label8" runat="server" Width="100%" CssClass="LABLES">Community</asp:label></TD>
																	...
																	<TD style="WIDTH: 122px"><asp:dropdownlist id="DrpCaste" runat="server" Width="100%" CssClass="textboxASR"></asp:dropdownlist></TD>
																...
																<TR>
																	<TD style="WIDTH: 78px; HEIGHT: 14px"><asp:label id="Label9" runat="server" Width="100%" CssClass="LABLES">DateofBirth</asp:label></TD>
																...
																<TR>
																	<TD style="WIDTH: 78px; HEIGHT: 15px"><asp:label id="Label10" runat="server" Width="100%" CssClass="LABLES">YearofPass</asp:label></TD>
																...
																<TR>
																	<TD style="WIDTH: 78px; HEIGHT: 6px"><asp:label id="Label11" runat="server" Width="100%" CssClass="LABLES">First&nbsp;Lang.</asp:label></TD>
																	...
																	<TD style="WIDTH: 98px; HEIGHT: 6px"><asp:label id="Label24" runat="server" Width="100%" CssClass="LABLES">Mother&nbsp;Tongue</asp:label></TD>
																	<TD style="HEIGHT: 6px"><asp:textbox id="TxtMtongue" runat="server" Width="100%" CssClass="textboxASR" MaxLength="150"></asp:textbox></TD>
																</TR>
																<TR>
																...
																<TR>
																	<TD style="WIDTH: 78px"><asp:label id="Label12" runat="server" Width="100%" CssClass="LABLES">1.&nbsp;A&nbsp;Mole&nbsp;on</asp:label></TD>
																...
																<TR>
																	<TD style="WIDTH: 78px"><asp:label id="Label13" runat="server" Width="100%" CssClass="LABLES">2.&nbsp;A&nbsp;Mole&nbsp;on</asp:label></TD>
