<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BoardTCPreviewMumbai.aspx.vb" Inherits="CollegeBoard.BoardTCPreviewMumbai" %>
			...
			<TABLE style="Z-INDEX: 101; LEFT: 8px; WIDTH: 742px; POSITION: absolute; TOP: 8px; HEIGHT: 1079px"
				...
				<TR>
					<TD height="50" width="348" colSpan="2" align="center" class="subheading1" style="WIDTH: 348px">TC 
						...
						&nbsp;/&nbsp;
						<asp:Label id="lblRcno" runat="server">Label</asp:Label>
                     

					</TD>
                   
					<TD height="50" width="45%" colSpan="2" align="center" class="subheading1">STUDENT ID:
						<asp:Label id="LblAdmno" runat="server">Label</asp:Label></TD>
				</TR>
                	<TR>
					<TD height="20" width="348" colSpan="2" align="center" class="subheading1" style="WIDTH: 348px">
                     

					</TD>
                   
					<TD height="20" width="45%" colSpan="2" align="center" class="subheading1">UID (ADHAR CARD NO.):
						<asp:Label id="lbluid" runat="server">Label</asp:Label></TD>
				</TR>
				...
				<TR>
					...
					<TD align="center" height="30" class="lables" style="WIDTH: 316px">
						<P>
							<asp:Label id="Label7" runat="server" Width="100%" Height="20px">Whether the Candidate belongs to NT-B OR NT-C OR NT-D</asp:Label>
							<asp:Label id="Label8" runat="server" Height="20px">or OBC or SBC OR SEBC OR VJ or other socially and </asp:Label>
				...
				<TR>
					<TD align="center" height="40" class="lables" style="HEIGHT: 40px">8</TD>
				...
				<TR>
					...
					<TD align="center" height="30" class="lables" style="WIDTH: 316px">Mother Tongue</TD>
					<TD align="center" height="30" class="lables" style="WIDTH: 15px"><STRONG>:</STRONG></TD>
					<TD align="left" height="30" class="lables">
			...
			<%--	<TR>
				...
				<TR>
					...
					<TD align="center" height="30" class="lables" style="WIDTH: 316px">
						...
						<asp:Label id="Label17" runat="server" Width="280px" Height="20px">Intermediate Course? (Incase of students</asp:Label>
				...
				<TR>
					...
					<TD align="center" height="30" class="lables" style="WIDTH: 316px">
						<asp:Label id="Label19" runat="server" Height="20px">Whether the pupil has been delcared eligible</asp:Label>
				...
				<TR>
					...
					<TD align="center" height="30" class="lables" style="WIDTH: 316px">
						...
						<asp:Label id="Label23" runat="server" Height="20px">Scholarship? (Nature of the sholarship to be</asp:Label>
