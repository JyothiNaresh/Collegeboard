<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BoardTCReportMumbai.aspx.vb" Inherits="CollegeBoard.BoardTCReportMumbai" %>
					...
					<TD>
						<TABLE id="Table4" cellSpacing="1" cellPadding="1" width="100%" border="1" runat="server">
							...
							<TR>
								...
								<TD width="20%"><asp:dropdownlist id="DrpCourse" runat="server" Width="120px" CssClass=" ">
                                    <asp:ListItem Value="0">--Select Course--</asp:ListItem>
                                                         <asp:ListItem Value="1">FYJC (Science)</asp:ListItem>
                                                         <asp:ListItem Value="2">SYJC (Science)</asp:ListItem>
								                </asp:dropdownlist></TD>
							</TR>
							<TR>
							...
							<TR>
                             ...
                             <tr>
                               <TD width="60%" style="HEIGHT: 2px"><asp:label id="Label14" runat="server" Width="100%" Height="15px" CssClass="Lables">PROGRESS IN STUDIES:</asp:label></TD>
								<TD style="HEIGHT: 2px"><asp:textbox id="TXTPISTUDIES" runat="server" Width="110px"></asp:textbox></TD>
                            </tr>
                             
                             <tr>
                               <TD width="60%" style="HEIGHT: 2px"><asp:label id="Label16" runat="server" Width="100%" Height="15px" CssClass="Lables">STD.IN WHICH STUDYING AND SINCE WHEN(IN FIGURE AND WORDS):</asp:label></TD>
								<TD style="HEIGHT: 2px"><asp:textbox id="TXTSTUDSINCE" runat="server" Width="400px"></asp:textbox></TD>
                            </tr>
                            <tr>
                               <TD width="60%" style="HEIGHT: 2px"><asp:label id="Label17" runat="server" Width="100%" Height="15px" CssClass="Lables">REASON FOR LEAVING COLLEGE:</asp:label></TD>
								<TD style="HEIGHT: 2px"><asp:textbox id="TXTREASON" runat="server" Width="400px"></asp:textbox></TD>
                            </tr>
                            <tr>
                               <TD width="60%" style="HEIGHT: 2px"><asp:label id="Label18" runat="server" Width="100%" Height="15px" CssClass="Lables">REMARKS:</asp:label></TD>
								<TD style="HEIGHT: 2px"><asp:textbox id="TXTREMARK" runat="server" Width="400px"></asp:textbox></TD>
                            </tr>
                             <tr>
                               <TD width="60%" style="HEIGHT: 2px"><asp:label id="Label19" runat="server" Width="100%" Height="15px" CssClass="Lables">CLASS TEACHER :</asp:label></TD>
								<TD style="HEIGHT: 2px"><asp:textbox id="TXTCLASSTEACHER" runat="server" Width="400px"></asp:textbox></TD>

                            </tr>
                             <tr>
                               <TD width="60%" style="HEIGHT: 2px"><asp:label id="Label20" runat="server" Width="100%" Height="15px" CssClass="Lables">CLEARK:</asp:label></TD>
								<TD style="HEIGHT: 2px"><asp:textbox id="TXTCLEARK" runat="server" Width="400px"></asp:textbox></TD>
                            </tr>
							<TR>
								<TD align="right" colSpan="2">
								<asp:button id="BtnTc" runat="server" Height="24px" Font-Bold="True" Font-Size="Larger" Text="Preview"></asp:button><asp:Button id="btnGeneratenewTC" runat="server" Height="24px" Text="Generate" Font-Size="Larger"
										Font-Bold="True" Visible="TRUE"></asp:Button><asp:button id="btnGenerate" runat="server" Height="24px" Font-Bold="True" Font-Size="Larger"
										Text="Generate" Enabled="False" Visible="false"></asp:button><asp:dropdownlist id="DrpQualifiedUniv" runat="server" Width="0px" CssClass=" ">
										...
										<P>
											<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0" runat="server">
												...
												<TR>
													...
													<TD width="20%"><asp:dropdownlist id="DrpStdYear" runat="server" Width="110px" CssClass=" ">
                                                        <asp:ListItem Value="0">--Select Course--</asp:ListItem>
                                                         <asp:ListItem Value="1">FYJC (Science)</asp:ListItem>
                                                         <asp:ListItem Value="2">SYJC (Science)</asp:ListItem>
													                </asp:dropdownlist></TD>
												...
												<TR>
													<TD align="right" colSpan="2">
														<asp:Button id="btnGeneratenewCC" runat="server" Height="24px" Visible="TRUE" Font-Bold="True"
															Font-Size="Larger" Text="Generate"></asp:Button><asp:button id="BtnCc" runat="server" Height="24px" Font-Bold="True" Font-Size="Larger" Text="Preview" Width="146px"></asp:button><asp:button id="btnCCGenerate" runat="server" Height="24px" Font-Bold="True" Font-Size="Larger"
