<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TcGenerateNew.aspx.vb" Inherits="CollegeBoard.TcGenerateNew" %>
										...
										<TR>
											<TD style="WIDTH: 540px" width="540" align="center">
												<TABLE id="Table5" border="0" cellSpacing="0" cellPadding="0" width="100%" align="center">
													...
													<TR>
														<TD style="HEIGHT: 17px" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:label id="Label36" runat="server" Height="9px" Width="228px" Font-Names="Calibri" CssClass="lables"
																Font-Size="Smaller">(Recognised by Govt. of Andhra Pradesh)</asp:label></TD>
													</TR>
													<TR>
