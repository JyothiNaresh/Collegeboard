<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BoardDetailsReport.aspx.vb" Inherits="CollegeBoard.BoardDetailsReport" %>
			...
			<TABLE id="Table1" style="Z-INDEX: 101; POSITION: absolute; TOP: 8px; LEFT: 8px" cellSpacing="0"
				...
				<TR>
					<TD style="HEIGHT: 202px" vAlign="top" align="center" colSpan="4">
						<TABLE id="Table12" cellSpacing="0" cellPadding="0" border="1">
							...
							<TR>
								<TD vAlign="middle" align="center" colSpan="9" class="auto-style4">
				...
				<TR>
					<TD vAlign="top" align="right" colSpan="4">
                        ...
                        <asp:textbox id="PageY" runat="server" Visible="false" Width="0px"></asp:textbox><asp:textbox id="PageX" runat="server" Visible="false" Width="0px"></asp:textbox><asp:imagebutton id="iBtnReport" runat="server" Width="80px" Height="20px" ImageUrl="../../../Images/NewImages/report.gif"></asp:imagebutton></TD>
				</TR>
			</TABLE>
		</FORM>
	</body>
