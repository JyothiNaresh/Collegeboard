<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Cetificates_Dtnew.aspx.vb" Inherits="CollegeBoard.Cetificates_Dtnew" %>
                                                        ...
                                                        <td class="TableBorder" valign="top" align="center">
                                                            ...
                                                            <table style="height: 56px" id="Table20" border="1" cellspacing="0" cellpadding="0" width="100%">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td style="width: 105px">
                                                                                <asp:Label ID="Label11" runat="server" Height="14px" Width="100%" CssClass="Lables"> Structural</asp:Label></td>
                                                                            <td style="width: 63px">
                                                                                <asp:DropDownList Style="z-index: 0" ID="drpstruc1" TabIndex="13" runat="server" Width="91px" CssClass=" "
                                                                                    AutoPostBack="True">
                                                                                    <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                    <asp:ListItem Value="1">Yes</asp:ListItem>
                                                                                    <asp:ListItem Value="2">No </asp:ListItem>
                                                                            ...
                                                                            <td style="width: 92px; height: 8px">
                                                                                <asp:DropDownList Style="z-index: 0" ID="drpstruc2" TabIndex="14" runat="server" Width="100%" CssClass=" ">
                                                                                    <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                    <asp:ListItem Value="1">Submitted</asp:ListItem>
                                                                                    <asp:ListItem Value="2">Not Submitted</asp:ListItem>
                                                                                </asp:DropDownList></td>
                                                                            <td style="width: 48px">
                                                                                <table style="z-index: 0" id="Table14" border="0" cellspacing="1" cellpadding="0" width="100%"
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>
                                                                                            <asp:TextBox Style="z-index: 0" ID="txtstrfmdate" TabIndex="15" runat="server" Width="85px" CssClass=" "
                                                                                                MaxLength="16" ToolTip="DD/MM/YYYY"></asp:TextBox></td>
                                                                                        <td>
                                                                                            <asp:TextBox Style="z-index: 0" ID="txtstrtodate" TabIndex="16" runat="server" Width="85px" CssClass=" "
                                                                                                MaxLength="16" ToolTip="DD/MM/YYYY"></asp:TextBox></td>
                                                                                        <td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 105px">
                                                                            <asp:Label ID="Label12" runat="server" Height="14px" Width="200px" CssClass="Lables">Affiliation for the academic year</asp:Label></td>
                                                                        <td style="width: 63px">
                                                                            <asp:DropDownList Style="z-index: 0" ID="drpAff" TabIndex="18" runat="server" Width="91px" CssClass=" "
                                                                                AutoPostBack="True">
                                                                                <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                <asp:ListItem Value="1">Yes</asp:ListItem>
                                                                                <asp:ListItem Value="2">No </asp:ListItem>
                                                                        ...
                                                                        <td style="width: 92px; height: 8px">
                                                                            <asp:DropDownList Style="z-index: 0" ID="drpaffsub" TabIndex="19" runat="server" Width="100%" CssClass=" ">
                                                                                <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                <asp:ListItem Value="1">Submitted</asp:ListItem>
                                                                                <asp:ListItem Value="2">Not Submitted</asp:ListItem>
                                                                            </asp:DropDownList></td>
                                                                        <td style="width: 48px">
                                                                            <table style="z-index: 0" id="Table10" border="0" cellspacing="1" cellpadding="0" width="100%"
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:TextBox Style="z-index: 0" ID="txtafffrom" TabIndex="20" runat="server" Width="85px" CssClass=" "
                                                                                            MaxLength="16" ToolTip="DD/MM/YYYY"></asp:TextBox></td>
                                                                                    <td>
                                                                                        <asp:TextBox Style="z-index: 0" ID="txtaffto" TabIndex="21" runat="server" Width="85px" CssClass=" "
                                                                                            MaxLength="16" ToolTip="DD/MM/YYYY"></asp:TextBox></td>
                                                                                    <td>
                                                                                        <input style="z-index: 0; width: 200px; height: 20px" id="cerAffpath1" tabindex="22" type="file"
                                                                                            name="cermunpath1" runat="server"></td>
                                                                                    <td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 63px">
                                                                            <asp:DropDownList Style="z-index: 0" ID="drpaddsec" TabIndex="18" runat="server" Width="91px" CssClass=" "
                                                                                AutoPostBack="True">
                                                                                <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                <asp:ListItem Value="1">Yes</asp:ListItem>
                                                                                <asp:ListItem Value="2">No </asp:ListItem>
                                                                        ...
                                                                        <td style="width: 92px; height: 8px">
                                                                            <asp:DropDownList Style="z-index: 0" ID="drpsubadd" TabIndex="19" runat="server" Width="100%" CssClass=" ">
                                                                                <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                <asp:ListItem Value="1">Submitted</asp:ListItem>
                                                                                <asp:ListItem Value="2">Not Submitted</asp:ListItem>
                                                                            </asp:DropDownList></td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 63px">
                                                                            <asp:DropDownList Style="z-index: 0" ID="drplease" TabIndex="18" runat="server" Width="91px" CssClass=" "
                                                                                AutoPostBack="True">
                                                                                <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                <asp:ListItem Value="1">Yes</asp:ListItem>
                                                                                <asp:ListItem Value="2">No </asp:ListItem>
                                                                        ...
                                                                        <td style="width: 92px; height: 8px">
                                                                            <asp:DropDownList Style="z-index: 0" ID="drpleasesub" TabIndex="19" runat="server" Width="100%" CssClass=" ">
                                                                                <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                <asp:ListItem Value="1">Submitted</asp:ListItem>
                                                                                <asp:ListItem Value="2">Not Submitted</asp:ListItem>
                                                                            </asp:DropDownList></td>
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 105px">
                                                                            <asp:Label ID="Label15" runat="server" Height="14px" Width="200px" CssClass="Lables">FDR</asp:Label></td>
                                                                        <td style="width: 63px">
                                                                            <asp:DropDownList Style="z-index: 0" ID="drpfdr" TabIndex="18" runat="server" Width="91px" CssClass=" "
                                                                                AutoPostBack="True">
                                                                                <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                <asp:ListItem Value="1">Yes</asp:ListItem>
                                                                                <asp:ListItem Value="2">No </asp:ListItem>
                                                                        ...
                                                                        <td style="width: 92px; height: 8px">
                                                                            <asp:DropDownList Style="z-index: 0" ID="drpfdrsub" TabIndex="19" runat="server" Width="100%" CssClass=" ">
                                                                                <asp:ListItem Value="0" Selected="True">Select</asp:ListItem>
                                                                                <asp:ListItem Value="1">Submitted</asp:ListItem>
                                                                                <asp:ListItem Value="2">Not Submitted</asp:ListItem>
                                                                            </asp:DropDownList></td>
                                                                        <td style="width: 48px">
                                                                            <table style="z-index: 0" id="Table18" border="0" cellspacing="1" cellpadding="0" width="100%"
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        <asp:TextBox Style="z-index: 0" ID="txtfdrfrom" TabIndex="20" runat="server" Width="85px" CssClass=" "
                                                                                            MaxLength="16" ToolTip="DD/MM/YYYY"></asp:TextBox></td>
                                                                                    <td>
                                                                                        <asp:TextBox Style="z-index: 0" ID="txtfdrto" TabIndex="21" runat="server" Width="85px" CssClass=" "
                                                                                            MaxLength="16" ToolTip="DD/MM/YYYY"></asp:TextBox></td>
                                                                                    <td>
                                                                                        <input style="z-index: 0; width: 200px; height: 20px" id="cerfdrpath1" tabindex="22" type="file"
                                                                                            name="cermunpath1" runat="server"></td>
                                                                                    <td>
