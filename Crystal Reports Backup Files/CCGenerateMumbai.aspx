<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CCGenerateMumbai.aspx.vb" Inherits="CollegeBoard.CCGenerateMumbai" %>
			...
			<TABLE style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute; TOP: 8px" id="Table4" border="0"
				...
				<TR>
					<TD align="center">
						...
						<TABLE style="WIDTH: 685px; HEIGHT: 534px" id="Table1" border="0" cellSpacing="1" cellPadding="1"
							width="585">
							<TR>
								<TD style="HEIGHT: 218px">
									<TABLE style="WIDTH: 627px; HEIGHT: 136px" id="Table2" border="0" cellSpacing="1" cellPadding="1">
										<TR>
											<TD style="WIDTH: 181px; HEIGHT: 120px"><asp:image id="Image1" runat="server" Width="100px" Height="109px" ImageUrl="~/Images/NewImages/Narayana Logo.jpg.jpg"></asp:image></TD>
											<TD style="HEIGHT: 100px" align="center">
												<P style="font-size: 9px">
                                                    <asp:label id="Label36" runat="server" Height="9px" Width="100%" Font-Size="Large" Font-Names="Calibri"
														CssClass="lables" ForeColor="#FF6600">NARAYANA EDUCATIONAL TRUST'S</asp:label>
													...
													<asp:Label id="LblColAddr" runat="server" Width="100%" Font-Size="9pt" Font-Names="Calibri"
														CssClass="lables"></asp:Label>
                                                     Phone No:<asp:label id="lblphone" runat="server" CWidth="100%" Font-Size="9pt" Font-Names="Calibri"
														CssClass="lables">Label</asp:label>
                                        ...
                                        <tr>
                                            <td></td>
                                            <TD style="WIDTH: 100%; Font-Size:9px; Font-Names:Calibri; font-weight: bold;"  align="center" >
                                               
                                                              Email Id:<asp:label id="lblemailid" runat="server" 
														CssClass="lables">Label</asp:label>
                                                       
                                          &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;     INDEX NO:<asp:label id="lblindexno" runat="server" 
														CssClass="lables">Label</asp:label>
									...
									<TABLE style="WIDTH: 625px; HEIGHT: 23px" id="Table3" border="0" cellSpacing="1" cellPadding="1"
                                        ...
                                        <TR>
											<TD style="WIDTH: 105px"><STRONG>UDISE No:</STRONG></TD>
											<TD style="WIDTH: 360px"><asp:label id="lbludise" runat="server" 
														 Font-Bold="True">Label</asp:label> </TD>
											<TD style="WIDTH: 43px"><STRONG>GR.NO:</STRONG></TD>
											<TD><asp:label id="lblGrno" runat="server" Font-Bold="True">Label</asp:label></TD>
										</TR>
									</TABLE>
									<%--<P>&nbsp;</P>--%>
								<%--</TD>
