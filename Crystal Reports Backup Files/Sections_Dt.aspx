<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Sections_Dt.aspx.vb" Inherits="CollegeBoard.Sections_Dt" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Sections_Dt</title>
		...
		<script type="text/javascript">
			$(function(){
				...
				$("#lstmCode").multiselect({noneSelectedText: "Select College Code",checkAllText:'Sel.All',uncheckAllText:'Rem.All',selectedList: 3,minWidth:200}).multiselectfilter({filter: function(event, matches){
					if( !matches.length ){ 
						}	}	});
							...
							<TABLE id="Table1" class="Panel" border="0" cellSpacing="0" cellPadding="0">
								<TR>
									<TD align="center">
												...
												<TD class="DarkColor">
													<TABLE id="Table3" border="0" cellSpacing="0" cellPadding="0" width="100%">
														<TR>
															...
															<TD class="SubHeading"><asp:label id="lblHeading" runat="server" Width="100%" Font-Bold="True" CssClass="SubHeading1"> List  of College Wise Details  of Sections </asp:label></TD>
												...
												<TD class="TableBorder" vAlign="top" align="center">
													<TABLE id="Table12" border="0" cellSpacing="0" cellPadding="0" width="200">
														<TR>
															...
															<TD><asp:imagebutton accessKey="G" style="Z-INDEX: 0" id="Imagebutton1" tabIndex="1" runat="server" Width="40px"
											...
											<TR>
												<TD class="TableBorder" vAlign="top" align="center"><asp:datagrid id="dgGridSection" tabIndex="1" runat="server" Width="198px" CssClass="GridMain"
														...
														<Columns>
															...
															<asp:BoundColumn Visible="False" DataField="SECSLNO" HeaderText="SLNO">
										...
										<TABLE style="WIDTH: 426px; HEIGHT: 397px" id="Table4" border="0" cellSpacing="0" cellPadding="0"
											width="426" runat="server">
											<TR>
												<TD align="center">
													<P>&nbsp;</P>
													<P>&nbsp;</P>
																...
																<TABLE id="Table7" border="0" cellSpacing="0" cellPadding="0">
																	<TR>
																		<TD class="DarkColor">
																			<TABLE id="Table8" border="0" cellSpacing="0" cellPadding="0" width="100%">
																				<TR>
																					<TD vAlign="top" width="11"><IMG src="../../Images/Login/table-lcorw.gif" width="11" height="11"></TD>
																					<TD class="SubHeading"><asp:label id="Label10" runat="server" Width="168px" Height="8px" Font-Bold="True" CssClass="SubHeading1"> Sections Entry Details </asp:label></TD>
																					<TD vAlign="top" width="11"><IMG src="../../Images/Login/table-rcorw.gif" width="11" height="11"></TD>
																				</TR>
																			</TABLE>
																		</TD>
																	...
																	<TR>
																		<TD class="TableBorder" vAlign="top" align="left">
																			...
																			<TABLE style="WIDTH: 330px; HEIGHT: 44px" id="Table5" border="0" cellSpacing="0" cellPadding="0"
																				width="330">
																				<TR>
																					...
																					<TD style="WIDTH: 29px"><asp:textbox style="Z-INDEX: 0" id="Txtccode" onkeypress="checkNum()" runat="server" Width="59px"
																							CssClass=" " MaxLength="10"></asp:textbox></TD>
																					<TD align="left"><asp:imagebutton accessKey="G" style="Z-INDEX: 0" id="imgBtnGo" tabIndex="1" runat="server" Width="75px"
																							Height="17px" ImageUrl="../../Images/NewImages/search.gif"></asp:imagebutton></TD>
																				</TR>
																				<TR>
																			...
																			<TABLE id="Table10" border="0" cellSpacing="0" cellPadding="0" width="100%">
																				<TR>
																					<TD style="WIDTH: 175px"><asp:label style="Z-INDEX: 0" id="Label3" runat="server" Width="192px" Height="19px" CssClass="Lables"> Orginal Science Sections</asp:label></TD>
																					<TD><asp:textbox style="Z-INDEX: 0" id="txtorgSci" tabIndex="2" runat="server" Width="136px" CssClass=" "
																							MaxLength="10"></asp:textbox></TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 175px"><asp:label style="Z-INDEX: 0" id="Label4" runat="server" Width="192px" Height="19px" CssClass="Lables"> Orginal Arts Sections</asp:label></TD>
																					<TD><asp:textbox style="Z-INDEX: 0" id="txtorgarts" tabIndex="3" runat="server" Width="136px" CssClass=" "
																							MaxLength="10"></asp:textbox></TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 175px"><asp:label style="Z-INDEX: 0" id="Label6" runat="server" Width="192px" Height="19px" CssClass="Lables"> Orginal Total  Sections</asp:label></TD>
																					<TD><asp:textbox style="Z-INDEX: 0" id="txtorgtot" tabIndex="4" runat="server" Width="136px" CssClass=" "
																							MaxLength="10"></asp:textbox></TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 175px"><asp:label style="Z-INDEX: 0" id="Label7" runat="server" Width="192px" Height="19px" CssClass="Lables"> Additional Science Sections</asp:label></TD>
																					<TD><asp:textbox style="Z-INDEX: 0" id="txtaddsci" tabIndex="5" runat="server" Width="136px" CssClass=" "
																							MaxLength="10"></asp:textbox></TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 175px"><asp:label style="Z-INDEX: 0" id="Label8" runat="server" Width="192px" Height="19px" CssClass="Lables">  Additional Arts Sections</asp:label></TD>
																					<TD><asp:textbox style="Z-INDEX: 0" id="txtaddarts" tabIndex="6" runat="server" Width="136px" CssClass=" "
																							MaxLength="10"></asp:textbox></TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 175px"><asp:label style="Z-INDEX: 0" id="Label9" runat="server" Width="192px" Height="19px" CssClass="Lables"> Additional Total  Sections</asp:label></TD>
																					<TD><asp:textbox style="Z-INDEX: 0" id="txtaddtot" tabIndex="7" runat="server" Width="136px" CssClass=" "
																							MaxLength="10"></asp:textbox></TD>
																				</TR>
																				<TR>
																					<TD style="WIDTH: 175px"><asp:label style="Z-INDEX: 0" id="Label1" runat="server" Width="192px" Height="19px" CssClass="Lables">Grand Total  (Org+Addn)</asp:label></TD>
																					<TD><asp:textbox style="Z-INDEX: 0" id="txtgtotal" tabIndex="13" runat="server" Width="136px" CssClass=" "
																							MaxLength="10"></asp:textbox></TD>
																				</TR>
																			</TABLE>
																		</TD>
